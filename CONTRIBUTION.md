...
## <a name='PullRequestsandCommits'></a>Pull Requests and Commits
...
### <a name='ConventionalCommitRules'></a>Conventional Commit Rules
...
### <a name='TestStyleGuidelines'></a>Test Style Guidelines
...
#### <a name='Directorystructureandfilenames'></a>Directory structure and file names
...
#### <a name='Systemtests'></a>System tests
...
#### <a name='Addingnewfunctionalitiesandtestsrequired'></a>Adding new functionalities and tests required
...
#### <a name='Updatingtests'></a>Updating tests
...
## <a name='Addinganewtranslatablelayersubjecttochange'></a>Adding a new translatable layer (subject to change)
...
### <a name='Portsandautomaticallycombininglayerssubjecttochange'></a>Ports and automatically combining layers (subject to change)
