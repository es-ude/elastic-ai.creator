...
class GenerateSpecificTestProcessTest(unittest.TestCase):
    def test_generate_test_process_for_one_input(self) -> None:
        ...
        test_process_string = get_test_process_for_one_input_results_in_one_output_string(inputs=[-1281, -1000, -500],
                                                                                          outputs=[0, 4, 28],
    ...
    def test_generate_test_process_for_multiple_inputs(self) -> None:
        ...
        test_process_string = get_test_process_for_multiple_input_results_in_one_output_string(
            inputs=inputs,
            outputs=outputs,
            output_name="y")
        for i in range(len(expected_test_process_lines)):
    ...
    def test_generate_test_process_multiple_inputs_raises_error_when_called_with_different_inputs_and_outputs_lenghts(
            self) -> None:
        self.assertRaises(TypeError, get_test_process_for_multiple_input_results_in_one_output_string, [1], [], "y")
