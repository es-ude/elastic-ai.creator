...
from elasticai.generator.generator_functions import generate_signal_definitions_for_lstm
...
def main():
    ...
    with open(file_path, "w") as writer:
        ...
        writer.write(get_variable_definitions_string({"c_out": "c_new_wo_activation",
                                                      "h_out": "h_new"}))
        # port mapping
        writer.write(get_port_map_string(map_name="FORGET_GATE_MAC",
                                         ...
                                         signals={"x1": "x",
                                                  ...
                                                  "b": "bf",
                                                  "y": "f_wo_activation"}))
        writer.write(get_port_map_string(map_name="FORGET_GATE_SIGMOID",
                                         component_name="sigmoid",
                                         signals=["f_wo_activation",
                                                  "f"]))
        writer.write(get_port_map_string(map_name="INPUT_GATE_MAC",
                                         component_name="mac_async",
                                         signals={"x1": "x",
                                                  "x2": "h_in",
                                                  "w1": "wii",
                                                  ...
                                                  "b": "bi",
                                                  "y": "i_wo_activation"}))
        writer.write(get_port_map_string(map_name="INPUT_GATE_SIGMOID",
                                         component_name="sigmoid",
                                         signals=["i_wo_activation",
                                                  "i"]))
        writer.write(get_port_map_string(map_name="CELL_GATE_MAC",
                                         component_name="mac_async",
                                         signals={"x1": "x",
                                                  "x2": "h_in",
                                                  "w1": "wig",
                                                  ...
                                                  "b": "bg",
                                                  "y": "g_wo_activation"}))
        writer.write(get_port_map_string(map_name="CELL_GATE_TANH",
                                         component_name="tanh",
                                         signals=["g_wo_activation",
                                                  "g"]))
        writer.write(get_port_map_string(map_name="NEW_CELL_STATE_MAC",
                                         component_name="mac_async",
                                         signals={"x1": "f",
                                                  "x2": "i",
                                                  "w1": "c_in",
        ...
        writer.write(get_port_map_string(map_name="NEW_CELL_STATE_TANH",
                                         component_name="tanh",
                                         signals=["c_new_wo_activation",
                                                  "c_new"]))
        writer.write(get_port_map_string(map_name="MAC_ASYNC_4",
                                         component_name="mac_async",
                                         signals={"x1": "x",
                                                  "x2": "h_in",
                                                  "w1": "wio",
                                                  ...
                                                  "b": "bo",
                                                  "y": "o_wo_activation"}))
        writer.write(get_port_map_string(map_name="SIGMOID_1",
                                         component_name="sigmoid",
