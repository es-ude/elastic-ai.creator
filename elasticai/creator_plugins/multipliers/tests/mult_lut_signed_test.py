...
from elasticai.creator_plugins.multipliers.tests.mult_lut_signed_tb import cocotb_settings
...
class VerilogMultiplierLutSigned(TestCase):
    @classmethod
    def setUpClass(cls):
