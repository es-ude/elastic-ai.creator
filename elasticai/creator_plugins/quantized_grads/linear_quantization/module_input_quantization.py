...
from .autograd import (
    ...
    QuantizeFakeLinearAsymForwStochasticAutograd, QuantizeLinearAsymForwHTEAutograd,
    QuantizeLinearAsymForwStochasticAutograd,
)
...
def get_linear_quantization_forw_module(
    ...
    class LinearQuantizationInputQuantizationModule(_InputModule):
    ...
    return LinearQuantizationInputQuantizationModule

InputQuantizeLinearAsymForwHTE: type[_InputModule] = get_linear_quantization_forw_module(
    QuantizeLinearAsymForwHTEAutograd
)
InputQuantizeLinearAsymForwStochastic: type[_InputModule] = get_linear_quantization_forw_module(
    QuantizeLinearAsymForwStochasticAutograd
)
