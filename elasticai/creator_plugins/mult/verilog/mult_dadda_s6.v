...
module MULT_DADDA_SIGNED_6BIT(
    ...
    ADDER_LUT_FULL ADD_S02(1'b1, IN[1][5], IN[2][4],      C00[2], S00[2]);
    ADDER_LUT_FULL ADD_S03(IN[2][5], IN[3][4], IN[4][3],  C00[3], S00[3]);
    ADDER_LUT_HALF ADD_S04(IN[3][2], IN[4][1],            C00[4], S00[4]);
    ADDER_LUT_FULL ADD_S05(IN[3][3], IN[4][2], IN[5][1],  C00[5], S00[5]);
    ...
    ADDER_LUT_FULL ADD_S14(S00[3], C00[2], IN[5][2],      C10[4], S10[4]);
    ...
    ADDER_LUT_FULL ADD_S25(S10[4], C10[3], C00[5],        C20[5], S20[5]);
    ...
    ADDER_LUT_FULL ADD_Q11(~IN[DATA_WIDTH-'d1][DATA_WIDTH-'d1], C20[DATA_WIDTH+'d1], C30[DATA_WIDTH+'d2], C30[DATA_WIDTH+'d3], Q[2*DATA_WIDTH-'d2]);
