...
cocotb_settings = dict(
    src_files=["mult_dadda_s4.v", 'adder_full.v', 'adder_half.v'],
    path2src=Path(test_dut.__file__).parent / 'verilog',
    top_module_name='MULT_DADDA_SIGNED_4BIT',
    cocotb_test_module="elasticai.creator_plugins.mult.tests.mult_dadda_s4_tb",
    params={}
)
