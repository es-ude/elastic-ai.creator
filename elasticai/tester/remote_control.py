...
from elastic_ai.tester.remote_control_protocol import RemoteControlProtocol
...
class RemoteControl:
    ...
    def read_skeleton_id(self) -> str:
        return str(self._rcp.read_skeleton_id())
...
def setup_arg_parser(parser: ArgumentParser):
    ...
    def predict(subparsers):
        ...
        def fn(rc: RemoteControl, args) -> None:
            result = rc.predict(bytes.fromhex(args.data), args.result_size)
            print(result)
