...
from elastic_ai.tester.message import Message
...
class MessageBuilder:
    def __init__(self) -> None:
        ...
        self.inference_output_length = 1
    ...
    def build(self) -> Iterable[Message]:
        match self.command:
            ...
            case Command.INFERENCE:
                yield from self._perform_inference()
    ...
    def _perform_inference(self) -> Iterable[Message]:
        yield self._new_msg(
            b"".join(
                map(
