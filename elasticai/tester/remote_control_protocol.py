from elastic_ai.tester.commands import Command
from elastic_ai.tester.io_stream import IOStream
from elastic_ai.tester.message_builder import MessageBuilder
from elastic_ai.tester.message_chunks_receiver import MessageChunksReceiver
from elastic_ai.tester.message_io import MessageIO
...
class RemoteControlProtocol:
    ...
    def predict(self, _input: bytes, output_length: int) -> bytes:
        ...
        self._msg_builder.inference_output_length = output_length
        self._send()
