...
class GenerateNetworkRootFileFromDifferentModelVersions(VHDLCodeTestCase):
    ...
    def get_generated_portmap_signal_line(self, signal_id, value) -> str:
        ...
        portmap = self.extract_section_from_code(begin="port (", end=");", lines=code)[
            0
        ]
...
class GeneratedNetworkVHDMatchesTargetForSingleModelVersion(VHDLCodeTestCase):
    ...
    def test_port_def_matches_target(self):
        ...
        actual = self.extract_section(begin="port (", end=");", lines=self.actual_code)
    ...
    def test_signal_defs_match_target(self):
        ...
        expected_signal_defs = self.code_section_from_string(
            """
    -- fp_linear
    ...
    signal fp_hard_sigmoid_y : std_logic_vector(15 downto 0);
        ...
        actual_sections = self.extract_section(
    ...
    def test_all_but_last_portmap_line_have_trailing_comma(self):
        portmaps = self.extract_section(begin="port map(", end=");", lines=self.actual_code)
    ...
    def check_portmaps(self, expected: str, portmap_start: str):
        ...
        actual: Iterable[Code] = self.extract_section(
