...
class GenerateSigmoidVhdTest(unittest.TestCase):
    def setUp(self) -> None:
        main()
        self.generated_file = open("../vhdl/source/sigmoid.vhd", "r")
        self.generated_lines = self.generated_file.readlines()
        self.expected_file = open("vhdl/vhdFiles/sigmoid_for_testing.vhd", "r")
    ...
    def test_generate_file(self) -> None:
        self.assertTrue(exists("../vhdl/source/sigmoid.vhd"))
