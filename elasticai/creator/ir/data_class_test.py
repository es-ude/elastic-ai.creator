...
"""
TESTS:
 - add a function to manually check data integrity by types
   - by names for dynamically added fields
   - by names for user added fields
   - by types for dynamically added fields
   - by names for user added fields
- improve error message by collecting all missing fields before raising error
- add function `get_missing_fields() -> dict[str, type]`
"""
