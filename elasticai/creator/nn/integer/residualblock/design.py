...
class ResidualBlock(Design):
    def __init__(
        ...
        if hasattr(self._shortcut, "create_design"):
            self.shortcut_design = self._shortcut.create_design(
                name=self._shortcut.name
            )
    ...
    def save_to(self, destination: Path) -> None:
        ...
        self.shortcut_design.save_to(destination.create_subpath(self._shortcut.name))
        ...
        template = InProjectTemplate(
            ...
            parameters=dict(
                ...
                conv1dbn_0_relu_x_addr_width=str(
                    self.conv1dbn_0_relu_deisgn._x_addr_width
                ),
                conv1dbn_0_relu_y_addr_width=str(
                    self.conv1dbn_0_relu_deisgn._y_addr_width
                ),
                ...
                shortcut_x_addr_width=str(self.shortcut_design._x_addr_width),
                shortcut_y_addr_width=str(self.shortcut_design._y_addr_width),
