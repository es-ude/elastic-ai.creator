...
class LSTMLayer(nn.Module):
    ...
    def forward(
        ...
        for t in range(self.seq_len):
            ...
            print("self.lstm_cell.h_next_QParams: ", self.lstm_cell.h_next_QParams)
            given_h_prev_QParams = self.lstm_cell.h_next_QParams
            given_c_prev_QParams = self.lstm_cell.c_next_QParams

        print("given_h_prev_QParams: ", given_h_prev_QParams)
        self.outputs_QParams = given_h_prev_QParams
        return h_next
