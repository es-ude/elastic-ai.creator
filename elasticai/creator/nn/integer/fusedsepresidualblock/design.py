...
class SepResidualBlock(Design):
    def __init__(
        ...
        name: str,
        data_width: int,
        sepconv1dbn_0: object,
        sepconv1dbn_0_relu: object,
        sepconv1dbn_1: object,
        shortcut: object,
        add: object,
        relu: object,
        ...
        self._sepconv1dbn_0 = sepconv1dbn_0
        self._sepconv1dbn_0_relu = sepconv1dbn_0_relu
        self._sepconv1dbn_1 = sepconv1dbn_1
        self._shortcut = shortcut
        self._add = add
        self._relu = relu

        self.sepconv1dbn_0_deisgn = self._sepconv1dbn_0.create_design(
            name=self._sepconv1dbn_0.name
        )
        self.sepconv1dbn_0_relu_deisgn = self._sepconv1dbn_0_relu.create_design(
            name=self._sepconv1dbn_0_relu.name
        )
        self.sepconv1dbn_1_deisgn = self._sepconv1dbn_1.create_design(
    ...
    def port(self) -> Port:
        return create_port(
            ...
            x_count=self.sepconv1dbn_0_deisgn._x_count,
            y_count=self.add_deisgn._y_count,
        )

    def save_to(self, destination: Path) -> None:
        self.sepconv1dbn_0_deisgn.save_to(destination)
        ...
        template_parameters = dict(
            ...
            sepconv1dbn_0_x_addr_width=str(self.sepconv1dbn_0_deisgn._x_addr_width),
            sepconv1dbn_0_y_addr_width=str(self.sepconv1dbn_0_deisgn._y_addr_width),
            sepconv1dbn_1_x_addr_width=str(self.sepconv1dbn_1_deisgn._x_addr_width),
            sepconv1dbn_1_y_addr_width=str(self.sepconv1dbn_1_deisgn._y_addr_width),
        ...
        if hasattr(self, "shortcut_design"):
            ...
            assert len(self.shortcut_design) == 1, (
        ...
        template_test = InProjectTemplate(
            ...
            parameters=dict(
                name=self.name,
                data_width=str(self._data_width),
                x_addr_width=str(self.sepconv1dbn_0_deisgn._x_addr_width),
                y_addr_width=str(self.add_deisgn._y_addr_width),
                in_channels=str(self._sepconv1dbn_0.in_channels),
                out_channels=str(self._add.num_dimensions),
                seq_len=str(self._sepconv1dbn_0.seq_len),
                work_library_name=self._work_library_name,
            ),
        )
