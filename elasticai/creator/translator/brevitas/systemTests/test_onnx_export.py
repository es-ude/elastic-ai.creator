...
from elasticai.creator.translator.brevitas.systemTests.models_definition import crete_brevitas_model
...
class SaveBrevitasModelToOnnx(BrevitasModelComparisonTestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.bigger_brevitas_model = crete_brevitas_model()

    def test_save_to_onnx(self) -> None:
        br = BrevitasRepresentation(original_model=None, translated_model=self.brevitas_model)
        br.save_to_onnx((3, 1, 132), path="brevitas_model.onnx")


    def test_bigger_model_save_to_onnx(self) -> None:
        br = BrevitasRepresentation(original_model=None, translated_model=self.bigger_brevitas_model)
