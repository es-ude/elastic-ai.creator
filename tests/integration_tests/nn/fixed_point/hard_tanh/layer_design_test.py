...
def test_build_test_hardtanh_design(total_bits: int, frac_bits: int) -> None:
    file_name = f"TestHardTanh_{total_bits}_{frac_bits}"
    dut = nn_creator.HardTanh(total_bits=total_bits, frac_bits=frac_bits)
