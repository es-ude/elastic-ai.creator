...
class SimplePrecomputedPReLU(torch.nn.Module):
    def __init__(
        self,
        total_width: int,
        frac_width: int,
...
def test_trainable_layer_precomputed_prelu(
    ...
    model = SimplePrecomputedPReLU(total_bits, frac_bits, num_steps, vrange)
