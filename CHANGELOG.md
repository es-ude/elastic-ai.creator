...
[9a8db3c](9a8db3c81c58c5ce8d096f828028ed0e51fd5167)...[bf39b74](bf39b7447160610f22c2d86668717edbd4f67bbf)

### Chore

- Move to py3.12 ([608bd50]( https://github.com/es-ude/elastic-ai.creator/commit/608bd5005422f6819d0f5acffebfea4ab83e39c2)) - [object], BREAKING CHANGE:everyone using only py3.11
- Add basic pyrefly config ([09b2f49]( https://github.com/es-ude/elastic-ai.creator/commit/09b2f4910b5e978f5ca53eefa25f49adbebdd00b)) - [object]
- Move simulation based tests to integration folder ([2802b71]( https://github.com/es-ude/elastic-ai.creator/commit/2802b7111885f9a9072b39d0f9650c3e3ec671f8)) - [object]
- Remove deprecated ir_transforms ([81a8270]( https://github.com/es-ude/elastic-ai.creator/commit/81a82705adaa262975710e3db04e21fee1abb6f4)) - [object]
- Remove old torch2ir ir2torch translations ([28e0695]( https://github.com/es-ude/elastic-ai.creator/commit/28e06959b208aa3d702ee5aa206279b69aff68df)) - [object]
- Improve plugin symbols type hints ([343a827]( https://github.com/es-ude/elastic-ai.creator/commit/343a8272ef8ed929bfda8b035c1d66df63e83898)) - [object]
- Remove deprecated ir ([0ea5f6d]( https://github.com/es-ude/elastic-ai.creator/commit/0ea5f6d92e3b2ad11d6d9dc4d1e226d03ce9ccc4)) - [object]
- Update devenv ([746365c]( https://github.com/es-ude/elastic-ai.creator/commit/746365cab2bd885ac91a34fd82584b9bdde83939)) - [object]
- Add claude and dual-graph files ([906d0e2]( https://github.com/es-ude/elastic-ai.creator/commit/906d0e280a26fbd0012efbb6ad75eb15c2f32b7f)) - [object]
- Add claude and dualgraph to gitignore ([aca1cb6]( https://github.com/es-ude/elastic-ai.creator/commit/aca1cb6a06e6809a09eb82c348a941c49415f6ea)) - [object]
- Use devenv direnvrc ([fb20930]( https://github.com/es-ude/elastic-ai.creator/commit/fb20930766051d9169623360720a88adf8c58ed7)) - [object]
- Update elastic ai runtime dep ([ba6527e]( https://github.com/es-ude/elastic-ai.creator/commit/ba6527eecd7f6aadd65aaf5adfbf109a461a6fb5)) - [object]
- Fix a type hint in data graph impl ([90cd737]( https://github.com/es-ude/elastic-ai.creator/commit/90cd7375381bc4132617b53447ca41137a8e3765)) - [object]
- Ignore devenv.local.yaml ([93e809c]( https://github.com/es-ude/elastic-ai.creator/commit/93e809c0163b26fc758b734fb4d45174116f555d)) - [object]
- Update to 2.0.6 ([5e150b0]( https://github.com/es-ude/elastic-ai.creator/commit/5e150b0d6c173a2af8016aed829ef0018b1fa066)) - [object]
- Add secretspec ([39b3865]( https://github.com/es-ude/elastic-ai.creator/commit/39b3865ce63139832f422eb67bb791959a89b50b)) - [object]
- Apply lint and test cleanup across integer/MPQ modules ([a1b402b]( https://github.com/es-ude/elastic-ai.creator/commit/a1b402b7f18e4791a8d7594b47b2c8b5a9d045b6)) - [object]
- Merge 'add-linear-quantization' into 'main' ([d52bcca]( https://github.com/es-ude/elastic-ai.creator/commit/d52bccae4b2fa3408ad79e996c9d231ad4e4f04d)) - [object]
- Update devenv related actions ([aead1df]( https://github.com/es-ude/elastic-ai.creator/commit/aead1df3d35046c9e3ce8232887b47cf5f61c708)) - [object]
- Use devenv from nixos unstable ([734b965]( https://github.com/es-ude/elastic-ai.creator/commit/734b965c5387eb6ced1da1f295525ee5a38ebd61)) - [object]
- Add scripts for running local checks and fixes ([92211ad]( https://github.com/es-ude/elastic-ai.creator/commit/92211ada906bc0886810ecf78afb02443b6f0a6e)) - [object]
- Move src files to src folder ([bcc98a5]( https://github.com/es-ude/elastic-ai.creator/commit/bcc98a5d54c1097b5f76992a1fee3f3a55350e1a)) - [object]
- Add ty as a type checker ([b1542ec]( https://github.com/es-ude/elastic-ai.creator/commit/b1542ec467ff5c7b3040d6c9e943db499c534d5a)) - [object]
- Remove deprecated rewriting features from graph package ([86a6f16]( https://github.com/es-ude/elastic-ai.creator/commit/86a6f16ef4d2f8c63ae818bcabd0e49decdad724)) - [object], BREAKING CHANGE:every client who was using the low-level rewriting
feature directly. However, that is quite unlikely.
- Filter out linker warnings in simulation test script ([b139ba5]( https://github.com/es-ude/elastic-ai.creator/commit/b139ba593d96a3baab90ea47900c7e9a41518ef7)) - [object]
- Remove astray print statements ([7b03a0b]( https://github.com/es-ude/elastic-ai.creator/commit/7b03a0b00401956a1af64e3f841c33a0c5f60d9e)) - [object]
- Disable automatic uv sync on devenv enterShell ([b4271d1]( https://github.com/es-ude/elastic-ai.creator/commit/b4271d1653fa0e2f65449e198ddac3c332241d38)) - [object]

### Docs

- Use flags for pytest ([1859abf]( https://github.com/es-ude/elastic-ai.creator/commit/1859abfc0dda087f22c99c5f8ed3279c905ece08)) - [object]
- Document hw component interfaces for pipelining ([6ec4db4]( https://github.com/es-ude/elastic-ai.creator/commit/6ec4db4fc342e3429275355fb611ea2caf594078)) - [object]
- Add a tldr for dev setup ([a84c078]( https://github.com/es-ude/elastic-ai.creator/commit/a84c07888ba25133a9a537c147cf6c3b5d6a2db6)) - [object]

### Feat

- Add new immutable graph ([69108e4]( https://github.com/es-ude/elastic-ai.creator/commit/69108e407b7f1af0d5a98da115f7a6cf54d65366)) - [object]
- Introduce immutable Attributes ([09dbd6b]( https://github.com/es-ude/elastic-ai.creator/commit/09dbd6b389fc2eec384c19534ccefb1181594a30)) - [object]
- Add new immutable ir data graph ([64701ad]( https://github.com/es-ude/elastic-ai.creator/commit/64701adee27dce6bab9f02a0407004b78ee2f242)) - [object]
- Add datagraph de/serializers ([2119625]( https://github.com/es-ude/elastic-ai.creator/commit/21196251c8925ba500c93caaf2463727f535c875)) - [object]
- Rewrite with new data graph ([ece0f0f]( https://github.com/es-ude/elastic-ai.creator/commit/ece0f0fa252a8c41a6c8dedf0e5f88162572333a)) - [object]
- Add new function_dispatch module ([29bd9fd]( https://github.com/es-ude/elastic-ai.creator/commit/29bd9fd8aa4eaac83a70a2f0bd9b05103297aec1)) - [object]
- Add translation pass plugin ([7c3040e]( https://github.com/es-ude/elastic-ai.creator/commit/7c3040e3d8bb8133820da781c6312f9aa1a35e57)) - [object]
- Use the new ir api with datagraphs ([0782c7a]( https://github.com/es-ude/elastic-ai.creator/commit/0782c7a45d14d16b04183cb6c415954580b96267)) - [object]
- Use new data graph api ([ce6ac20]( https://github.com/es-ude/elastic-ai.creator/commit/ce6ac20514b0a8bd6e577a2237be5fbc7544a3b9)) - [object]
- Use new datagraph api in ir2vhdl and plugins ([0503655]( https://github.com/es-ude/elastic-ai.creator/commit/0503655c6197c3519925eaeb337c6e4e33dec61d)) - [object]
- Use the new data graph api ([9713f0f]( https://github.com/es-ude/elastic-ai.creator/commit/9713f0f687077dd3adc5d5b9e547eced686c3667)) - [object], BREAKING CHANGE:old ir data types removed
- Make ir flavor for hdl part of public api ([dd7e4a8]( https://github.com/es-ude/elastic-ai.creator/commit/dd7e4a84641e7c6c62717a0bde82e31b6e6f8c45)) - [object]
- Use proper double dispatch for plugin loading ([f6c92ae]( https://github.com/es-ude/elastic-ai.creator/commit/f6c92ae8f005ea03d77d3249fd64fce5c9194e80)) - [object]
- Add code generation for wires and module instances ([8dd852b]( https://github.com/es-ude/elastic-ai.creator/commit/8dd852b6b4a47b6ad3ebaec3d6fbbaa734845bf0)) - [object]
- Add hdl generator abstraction ([15cae5d]( https://github.com/es-ude/elastic-ai.creator/commit/15cae5d986d76bf29b6c49b5c3a0e0bed3e4e679)) - [object]
- Use ring buffer for shift register ([fe74331]( https://github.com/es-ude/elastic-ai.creator/commit/fe74331651049ab167407e6c69c505db1be52bde)) - [object]
- Support nested sequences, mappings for test parameters ([8fefcd2]( https://github.com/es-ude/elastic-ai.creator/commit/8fefcd2ad26501f7631182a8af5f414c367eeb5a)) - [object]
- Add optional file filter ([462cd01]( https://github.com/es-ude/elastic-ai.creator/commit/462cd01b878b3c781b457d626a80d8aff4d1c883)) - [object]
- Use new ir and new pipelining interface ([916b6df]( https://github.com/es-ude/elastic-ai.creator/commit/916b6df8e2b8b68da6db1253299a69c9f5d4c5c5)) - [object]
- Properly render repr for EdgeImpl ([afbc2cc]( https://github.com/es-ude/elastic-ai.creator/commit/afbc2ccf0ce968816be1973f3cf8b895fe9b5fe5)) - [object]
- Add conv2d, batchnorm2d, maxpool2d, adaptiveavgpool2d, functional add to default handlers; add Translators with Params and Translator with params and buffers ([f0e83ef]( https://github.com/es-ude/elastic-ai.creator/commit/f0e83ef7117e2f30dcadb7a62a4f6744473dcad5)) - [object]
- Support templated constant values ([ae26e69]( https://github.com/es-ude/elastic-ai.creator/commit/ae26e6929e8d4f7c7989acbd0ae964266709a913)) - [object]
- Add output shape functions for all default torch layers ([45d5268]( https://github.com/es-ude/elastic-ai.creator/commit/45d5268e42e2661802a0eec0f3a888e8298b5aa5)) - [object]
- Automate interaction with simulated hw layers ([8f3d796]( https://github.com/es-ude/elastic-ai.creator/commit/8f3d796a1b078ed837b4808622deae83ebc4af69)) - [object]
- Add binary filter plugin ([6e2a3ad]( https://github.com/es-ude/elastic-ai.creator/commit/6e2a3ad772876f12ec3126460beaff4c56d65110)) - [object]
- Integer quantized linear layer now uses the shared rom ([015afb5]( https://github.com/es-ude/elastic-ai.creator/commit/015afb50a835b060ec57a1702117ac88e5f8755f)) - [object]
- Enable generating makefile by Creator ([12a8a56]( https://github.com/es-ude/elastic-ai.creator/commit/12a8a56c724d2a0e11a700b13bae48c061bc008e)) - [object]
- Added,tested subtract function,finished replacement ([0444926]( https://github.com/es-ude/elastic-ai.creator/commit/0444926351d703066a08fbdecf3659f389fdfeb5)) - [object]
- Added,test addition function, finished replacement ([02a3af4]( https://github.com/es-ude/elastic-ai.creator/commit/02a3af410264f2035f97fcb65985117c59b59ac6)) - [object]
- Added, tested matmul function,finished replacement ([9b66245]( https://github.com/es-ude/elastic-ai.creator/commit/9b6624581c2f1883462f63d19edeb244438be790)) - [object]
- Split QParams to four types ([941c21f]( https://github.com/es-ude/elastic-ai.creator/commit/941c21f0771473804537ea237458afed6c31a30e)) - [object]
- Wrote test for calculate_quant_params ([8842d54]( https://github.com/es-ude/elastic-ai.creator/commit/8842d54deebecfcb721a71af41d920a9e35922f5)) - [object]
- Added test for simulate_bitshifting ([7bc5f44]( https://github.com/es-ude/elastic-ai.creator/commit/7bc5f442a8754e55b1cdfd537863ef39dc3f7db4)) - [object]
- Added test for SimQuant ([3df8c8f]( https://github.com/es-ude/elastic-ai.creator/commit/3df8c8f416ee790153a0a7e82355c3b777236779)) - [object]
- Addded test for QParams ([b9de7e8]( https://github.com/es-ude/elastic-ai.creator/commit/b9de7e86092b2301779854b5c146e45d3c47611b)) - [object]
- Added test for create_makefile ([de76b66]( https://github.com/es-ude/elastic-ai.creator/commit/de76b66694dabf32bcdf2659a2effab0ef2c08a8)) - [object]
- Added test for relu.py ([bcc810f]( https://github.com/es-ude/elastic-ai.creator/commit/bcc810f790cbf890145dcbe77e4a3d9b4638972c)) - [object]
- Wrote test of the design of linear ([0d58248]( https://github.com/es-ude/elastic-ai.creator/commit/0d58248305ccb21f156d0ae1aca9dd193861a49a)) - [object]
- Wrote test of the design of relu ([c193f90]( https://github.com/es-ude/elastic-ai.creator/commit/c193f908f661a5edb639554864e8ecae3fc9e19a)) - [object]
- Added separated tests for chekcing given_input_QParams and update_quant_params of input_QParams in linear ([c3a4671]( https://github.com/es-ude/elastic-ai.creator/commit/c3a46713ed062ee77b15e9220b0366c818320806)) - [object]
- Added test_forward in teat_linear ([fdaeeef]( https://github.com/es-ude/elastic-ai.creator/commit/fdaeeeff9c1f7d876ecd87cfb02454698b5c7a77)) - [object]
- Added test for design of sequential ([ca7fa35]( https://github.com/es-ude/elastic-ai.creator/commit/ca7fa35b99a5acbff73bebdad06d991fcb58a983)) - [object]
- New components for CNN quantization ([e0ee193]( https://github.com/es-ude/elastic-ai.creator/commit/e0ee1931a59cb36a400827ef0e1b722ffd956292)) - [object]
- Added initial vhdl templates of components for CNN ([3e544fb]( https://github.com/es-ude/elastic-ai.creator/commit/3e544fb4b8c40477c336ec318b3fcbd789b2664b)) - [object]
- Added two type of VHDL templates for conv1dbn with or without padding ([9411ccd]( https://github.com/es-ude/elastic-ai.creator/commit/9411ccda18e8415bfcf19c9bf09852e67cd21923)) - [object]
- Added new componet for concatenating ([adcb71e]( https://github.com/es-ude/elastic-ai.creator/commit/adcb71ea2f6f1767c50aa7510cbe75e82d5b9130)) - [object]
- Added new componethardsigmoid ([2b14387]( https://github.com/es-ude/elastic-ai.creator/commit/2b1438775b70cb6379b5861e00fc0a94662e53fd)) - [object]
- Added new component of hardtanh ([5b3ef8f]( https://github.com/es-ude/elastic-ai.creator/commit/5b3ef8f54bfcbd8d9c13ccdd58d9eb5fe9cd5aa6)) - [object]
- Added new component of hadamardproduct ([d42167e]( https://github.com/es-ude/elastic-ai.creator/commit/d42167e21611898c5684fc8070286a6d526f765f)) - [object]
- Added new component of lstm cell ([9afc8a9]( https://github.com/es-ude/elastic-ai.creator/commit/9afc8a9e061625da166bb1240bf8ee990db4845c)) - [object]
- Added new component of lstm layer ([2c10acb]( https://github.com/es-ude/elastic-ai.creator/commit/2c10acb51a67fea0b4e9cae26770ba3898112665)) - [object]
- Added new component of LSTM block ([a7cf8ff]( https://github.com/es-ude/elastic-ai.creator/commit/a7cf8ff7e9e7e2a0d48e506214af8a1e30cdc907)) - [object]
- Inserted Transformer quantization-related code to Creator ([5066f17]( https://github.com/es-ude/elastic-ai.creator/commit/5066f172ec323e45de04563f0379eaae4deca27f)) - [object]
- Inserted GRUCell ([7be3126]( https://github.com/es-ude/elastic-ai.creator/commit/7be31261d0fe8e5a4000df4d95b7c2190cc67c15)) - [object]
- Inserted vhdl-realted files for 4-D matrixmultiplication ([55a5a4c]( https://github.com/es-ude/elastic-ai.creator/commit/55a5a4c3808af12107b71bdd5f0546798a03a4e6)) - [object]
- Adding vhdl-related files for bn1d ([1bb3b49]( https://github.com/es-ude/elastic-ai.creator/commit/1bb3b492eea9adad66ddd303c0998690ca1d8ddb)) - [object]
- Adding vhdl-related files for softmaxLUT ([84357b2]( https://github.com/es-ude/elastic-ai.creator/commit/84357b2974c199c9b07b5bcf40458202b50c9f38)) - [object]
- Adding vhdl-related files for innerattention ([0bb3046]( https://github.com/es-ude/elastic-ai.creator/commit/0bb3046e52025fe604dda93bffc38bff41cc8070)) - [object]
- Adding vhdl-related files for mha ([0f69afb]( https://github.com/es-ude/elastic-ai.creator/commit/0f69afb29613ced4a85861e7631aa97874fa61cd)) - [object]
- Adding vhdl-related files for ffn ([fd3a9fd]( https://github.com/es-ude/elastic-ai.creator/commit/fd3a9fd7add816d250d1e2b57a44644c9fc7e108)) - [object]
- Adding vhdl-related files for encoderlayer ([8494756]( https://github.com/es-ude/elastic-ai.creator/commit/84947567ff2debc41d59c2739376b887b1d7f1ec)) - [object]
- Adding vhdl-related files for encoder ([f27400a]( https://github.com/es-ude/elastic-ai.creator/commit/f27400a4491b2c0aa265c1101ef439d8446a89a4)) - [object]
- Adding vhdl-related files for LUT ([ff7f651]( https://github.com/es-ude/elastic-ai.creator/commit/ff7f6519e596dd3bf4c984b75a1e2a2530d819e2)) - [object]
- Including more vhdl templates for linear ([be254cf]( https://github.com/es-ude/elastic-ai.creator/commit/be254cfa54f33955a65a8381f17c49e6345e3afd)) - [object]
- Distinguish avgpooling1d and avgpooling1d with flatten ([9e4b092]( https://github.com/es-ude/elastic-ai.creator/commit/9e4b092ebc3c0c5218e74ba638723c432696545d)) - [object]
- Inserted some VHDL templates for LSTM ([dd1dd43]( https://github.com/es-ude/elastic-ai.creator/commit/dd1dd43c6914474451dddcfbdfa0ccdd9640f80a)) - [object]
- Finished HardSigmoid VHDL templates for integer-only quantization ([69ea7fe]( https://github.com/es-ude/elastic-ai.creator/commit/69ea7fe438de2bdaf442c4eaa3d73f742f8efb91)) - [object]
- Inserted new component SepConv1dBN ([1acea0d]( https://github.com/es-ude/elastic-ai.creator/commit/1acea0dfe36383446348cc34b8957bf9341b198b)) - [object]
- Inserted a fused sepresidualblock for being compatible for sepconv1dbn ([98cbb3c]( https://github.com/es-ude/elastic-ai.creator/commit/98cbb3c84cec597a9c884f30ec4fb911350ffac6)) - [object]
- Prepared quantization code for fusedFFN ([814543c]( https://github.com/es-ude/elastic-ai.creator/commit/814543c95538e8488d6266e02b1c66d68b3cdaca)) - [object]
- Inserted improved FFN module ([d330fc0]( https://github.com/es-ude/elastic-ai.creator/commit/d330fc06833dff5757cafaeb66abdbd8552ea0fe)) - [object]
- Introduce a new param to enable warmup qat ([b54d68d]( https://github.com/es-ude/elastic-ai.creator/commit/b54d68d2ca04081ba5e0c22d1a24888d34c8038a)) - [object]
- Add parallelised linear ([3b48f5d]( https://github.com/es-ude/elastic-ai.creator/commit/3b48f5d4643d0c65b8f30ac63b89beed8f4b326d)) - [object]
- Add interface for linear layer to set unroll factor ([3d57b8c]( https://github.com/es-ude/elastic-ai.creator/commit/3d57b8c81db99afdeccbbcd489096ea0746f2656)) - [object]
- Add interface for LSTM to set unroll factor ([f0a513f]( https://github.com/es-ude/elastic-ai.creator/commit/f0a513f9a19393ff7f454461721ce4b78cdc43ad)) - [object]
- Make lstm network support 200MHz ([1a9e670]( https://github.com/es-ude/elastic-ai.creator/commit/1a9e67073172965e5ca59546a44b7397de37dbe3)) - [object]
- Enable between layer pipeline ([2b7a976]( https://github.com/es-ude/elastic-ai.creator/commit/2b7a9769c6175ad4d0d8171cc6bf77bdb101ce98)) - [object]
- Inserted quant error analysis function ([87124a1]( https://github.com/es-ude/elastic-ai.creator/commit/87124a1179c8e8768be3aeea624b2b08dedbdc82)) - [object]
- Supported MPQ for Transformer ([ca1bf19]( https://github.com/es-ude/elastic-ai.creator/commit/ca1bf194a4a2f98b426ec8a4cfaed766f32fe7d0)) - [object]
- Inserted MPQ_strategy selection into Addition ([6ce4298]( https://github.com/es-ude/elastic-ai.creator/commit/6ce42980086685671ec6138b09f6b139fe4fc035)) - [object]
- Inserted MPQSupport ([ab3577b]( https://github.com/es-ude/elastic-ai.creator/commit/ab3577b414e8cbbb3701382a6944d40be66ee459)) - [object]
- Inserted MPQ support for basic components of Transformer ([f124894]( https://github.com/es-ude/elastic-ai.creator/commit/f124894fcc6af7574920a4ecf8315ad9ecda0de8)) - [object]
- Added MPQ support for addition's VHDL ([4e6f257]( https://github.com/es-ude/elastic-ai.creator/commit/4e6f257b30d14d413b3207dd6acc7c1d43092395)) - [object]
- Added MPQ support for AVGPoolflatten's VHDL ([f3fe3f9]( https://github.com/es-ude/elastic-ai.creator/commit/f3fe3f923f989f78dad79d7485f72c02df52c2ad)) - [object]
- Add 1to1 impl of hardsigmoid, and bug fix ([34982b8]( https://github.com/es-ude/elastic-ai.creator/commit/34982b85352c9ffb324fb4c2c4f9341deb5399d7)) - [object]
- Add setp func impl of hardsigmoid, and tested with simulation ([62cc585]( https://github.com/es-ude/elastic-ai.creator/commit/62cc5852973941b7f5f15299304a966b716c3ce8)) - [object]
- Support sets of start nodes for bfs iterators ([715818d]( https://github.com/es-ude/elastic-ai.creator/commit/715818d415ddba464c8732da8cddf10b2a6dbfcf)) - [object]
- Data graphs can now be cleared ([ab7d102]( https://github.com/es-ude/elastic-ai.creator/commit/ab7d1028c96a460d668ee775d42bf281b31b398c)) - [object]
- Make rewriting api generic over consumed datagraphs ([6d2ef9e]( https://github.com/es-ude/elastic-ai.creator/commit/6d2ef9ef471741de3a729fb93a580bd09c7c16bc)) - [object]
- Allow to just pass a registry to the translation ([bf39b74]( https://github.com/es-ude/elastic-ai.creator/commit/bf39b7447160610f22c2d86668717edbd4f67bbf)) - [object]

### Fix

- Use correct interface in matching algorithm ([224046f]( https://github.com/es-ude/elastic-ai.creator/commit/224046fea02cc016b36a1b806c9bfb06173d6dd6)) - [object]
- Fix translation failing for multi sub modules ([36f8f0e]( https://github.com/es-ude/elastic-ai.creator/commit/36f8f0e76f32f88d9cc3b3995a51bdc201064b5f)) - [object]
- Add `positive` to supported types for generics ([99fe5b4]( https://github.com/es-ude/elastic-ai.creator/commit/99fe5b45ece5cbd1b9f18176f7a3ed02485c8c6e)) - [object]
- Fix function signatures for template params ([a2e7e70]( https://github.com/es-ude/elastic-ai.creator/commit/a2e7e7040e8816c16dbb59a79dbfdbee642c5569)) - [object]
- Remove vunit completely ([3d3d67b]( https://github.com/es-ude/elastic-ai.creator/commit/3d3d67ba4954794c91b8566754a7aa95973b2a45)) - [object]
- Support getting files from subfolders ([185062d]( https://github.com/es-ude/elastic-ai.creator/commit/185062d50123e0086bf827fae3b98fec595378b6)) - [object]
- Yield of static and generated files ([be31db6]( https://github.com/es-ude/elastic-ai.creator/commit/be31db640e6e142e7dfae384726c7d45f74c3560)) - [object]
- Order grouped filter kernels correctly ([0794e69]( https://github.com/es-ude/elastic-ai.creator/commit/0794e69d1b41ac0d1b9b3a924126898eb305aa6f)) - [object]
- Fix mypy type errors for shape inference module ([56f4110]( https://github.com/es-ude/elastic-ai.creator/commit/56f4110c3f828c2e1f0cbd44002832024074daa6)) - [object]
- Slice bytes for hw function id correctly ([35177ba]( https://github.com/es-ude/elastic-ai.creator/commit/35177baa2d02dfbc14e3913287199ecc2b139d4f)) - [object]
- Fix skeleton implementation and add system tests ([4f100df]( https://github.com/es-ude/elastic-ai.creator/commit/4f100dfd734612c67fbcee0d21d417dc3353b1ef)) - [object]
- Update gitignore ([8d87d44]( https://github.com/es-ude/elastic-ai.creator/commit/8d87d4491b89170a5aafc423b326ae86ac505699)) - [object]
- Network's vhdl files will be stored in network folder ([3da6206]( https://github.com/es-ude/elastic-ai.creator/commit/3da6206c24cfca90f20014e993c168014b828956)) - [object]
- Solve a bug regarding if saved weights should subtract zero or not ([4b9ed80]( https://github.com/es-ude/elastic-ai.creator/commit/4b9ed8085b69983b54224b723fdc6ddd816dfc5c)) - [object]
- Solve problem with get in_features and out_features in design of network ([88d4c4d]( https://github.com/es-ude/elastic-ai.creator/commit/88d4c4d531feb2c083f69024372b9963fbc4c4a4)) - [object]
- Remove the shared design.py in the integer folder ([36adc2c]( https://github.com/es-ude/elastic-ai.creator/commit/36adc2ce721e09fc7d5fd6c01fd3cdb745a310de)) - [object]
- Removed the shared template.py in the integer folder ([da48727]( https://github.com/es-ude/elastic-ai.creator/commit/da487270d80fa822e4b7eb1091a71720554c08d7)) - [object]
- Remove unused import from pathlib ([605a54e]( https://github.com/es-ude/elastic-ai.creator/commit/605a54e3db84222ed318222c9d7486dd9c3016dd)) - [object]
- Set correct type hint ([08bdaad]( https://github.com/es-ude/elastic-ai.creator/commit/08bdaad58fce415925112d40f0b43bb245e7f848)) - [object]
- Rom names are now generated correctly ([42c2aec]( https://github.com/es-ude/elastic-ai.creator/commit/42c2aec1b90d0d222c8bb4bbdd9033178f93c28d)) - [object]
- Netwrok's vhdl files should be stored in the network folder to support GHDL simulation ([960087d]( https://github.com/es-ude/elastic-ai.creator/commit/960087d1cb4f84eb7385692b198438b69d8b51b9)) - [object]
- Update makefile to support vivado simulation ([77027eb]( https://github.com/es-ude/elastic-ai.creator/commit/77027eb28669d490cc04d4743bdd1946b1342836)) - [object]
- Improved QuantizedTensorValidator ([4fe7486]( https://github.com/es-ude/elastic-ai.creator/commit/4fe74863e5c2931c00be39d684b4340541bbcfa1)) - [object]
- Solved the fixed data width of scaler in the vhdl tp ([c20425e]( https://github.com/es-ude/elastic-ai.creator/commit/c20425ec0268cb544e8c7a4686d9ac2be4ce5bb2)) - [object]
- Improved quantizedProcess, added and finished test ([c5ec651]( https://github.com/es-ude/elastic-ai.creator/commit/c5ec651e863828ccf3dc696f80dba60f38349eb3)) - [object]
- Simplied the way to save quantized data for hardware simulation ([2b94634]( https://github.com/es-ude/elastic-ai.creator/commit/2b9463488858e4ffedf0521034482d6f4e180799)) - [object]
- Added __pycache__ in .gitignore ([b4f6560]( https://github.com/es-ude/elastic-ai.creator/commit/b4f6560c442d1abdf32e2b4fc4759a67cde5023d)) - [object]
- Removed unused code in forword() of linear ([22dce6f]( https://github.com/es-ude/elastic-ai.creator/commit/22dce6febc68a054efadc5dfd08de66fc32834c0)) - [object]
- Removed unused code in forward() of relu ([8daf6ee]( https://github.com/es-ude/elastic-ai.creator/commit/8daf6ee5acd758745b223e0eed8926adebbdd0be)) - [object]
- Rename variables in scaling_M() to avoid confusion ([c16e5d6]( https://github.com/es-ude/elastic-ai.creator/commit/c16e5d67277def617f586c31498e057395f5e049)) - [object]
- Simplified the way calling simulate_bitshifting() ([c73559d]( https://github.com/es-ude/elastic-ai.creator/commit/c73559d6caf3eb8c034e84d4cee8d08381a98cfe)) - [object]
- Modified the way to get maximum in int_forward() of relu ([ac38533]( https://github.com/es-ude/elastic-ai.creator/commit/ac38533eb7447971c98acef1063fd186ef3d0141)) - [object]
- Merged quantize and dequantize into QParams ([b6a8a59]( https://github.com/es-ude/elastic-ai.creator/commit/b6a8a59f02ad090e3f61727b083b6da8af707885)) - [object]
- Removed QuantizedTensorValidator ([1850369]( https://github.com/es-ude/elastic-ai.creator/commit/18503691b138ee84e03201ab1c2d9d49be765af4)) - [object]
- Renamed FakeQuantize as SimQuant ([02cadc8]( https://github.com/es-ude/elastic-ai.creator/commit/02cadc8806ae3ed9b9715ec05cc40ba2b53ec9c1)) - [object]
- Merged math operation into a class ([fcd6f4c]( https://github.com/es-ude/elastic-ai.creator/commit/fcd6f4c4180e51c8e7f6dc1fa8845fcae8083478)) - [object]
- Simplified observer, distinguished global and local MinMax, wrote test for GlobalMinMax ([a80b815]( https://github.com/es-ude/elastic-ai.creator/commit/a80b8151aaffc66fab4b26f963644efaf59f2ced)) - [object]
- Removed device-related code in integer folder ([010c76f]( https://github.com/es-ude/elastic-ai.creator/commit/010c76f402a13c409f0347c1c85e98edc9028b4e)) - [object]
- Changed the test framework used by MathOperations_test ([2f9ed4a]( https://github.com/es-ude/elastic-ai.creator/commit/2f9ed4aece831ac250ca1882e3f60f7c33550d75)) - [object]
- Changed the test framework used by calculate_quant_params_test ([5dce069]( https://github.com/es-ude/elastic-ai.creator/commit/5dce0692f24f8b355202eb4935b035fcc22ec3ae)) - [object]
- Changed the test framework used by Observers_test ([e8eab4b]( https://github.com/es-ude/elastic-ai.creator/commit/e8eab4b2200afbb8e61e7eef41794d67bc9cfd09)) - [object]
- Changed the test framework used by QParams_test ([2ea4367]( https://github.com/es-ude/elastic-ai.creator/commit/2ea436755e5ad07bcbaa7ec6b2721136441d6a91)) - [object]
- Changed the test framework used by SimQuant_test ([edcb999]( https://github.com/es-ude/elastic-ai.creator/commit/edcb9998a728315db7ceaa52ee55dbdf6b035370)) - [object]
- Changed the test framework used by simulate_bitshifting_test ([fe3e2ec]( https://github.com/es-ude/elastic-ai.creator/commit/fe3e2ecdb65317a73da4b69752b729e32cb8fe8f)) - [object]
- Changed the test framework used by create_makefile_test ([bd73847]( https://github.com/es-ude/elastic-ai.creator/commit/bd73847da77e3cd5512ea07a3558519dcbe5e922)) - [object]
- Simplified _get_quantized_weights() and _get_quantized_bias() in linear.py and worte test ([b9dc24f]( https://github.com/es-ude/elastic-ai.creator/commit/b9dc24f02664d48a7b2a55ab8ed6b99bcf59eeb4)) - [object]
- Simplified precompute() in linear.py and wrote test for linear.py ([4e0dfea]( https://github.com/es-ude/elastic-ai.creator/commit/4e0dfea1ee84ebc16157b9dbf344bb2e551a4709)) - [object]
- Unified m_q and m_q_shift ([7abd41c]( https://github.com/es-ude/elastic-ai.creator/commit/7abd41c1f5b5ccab09291be752bd409c52413cd5)) - [object]
- Solved the problem with .strip() in design_test of linear ([01f7173]( https://github.com/es-ude/elastic-ai.creator/commit/01f71739dbb723ef7d0a3b58ec365cc4b170bcfc)) - [object]
- Template_test.py changes to pytest framework ([d249195]( https://github.com/es-ude/elastic-ai.creator/commit/d24919532a609b0818240641c575c4023526ff25)) - [object]
- Removed unused playground.ipynb ([32a50f5]( https://github.com/es-ude/elastic-ai.creator/commit/32a50f535cfecfcc5e337d42344b66d03dcdbaf4)) - [object]
- Put device designation back ([2396bb2]( https://github.com/es-ude/elastic-ai.creator/commit/2396bb225a3f788f7f491600222457be0dcb716f)) - [object]
- Improved the way assign device ([43c2819]( https://github.com/es-ude/elastic-ai.creator/commit/43c2819e5e19879236d1a5da98a44aad40e8c123)) - [object]
- Changed input_QParams to inputs_QParams ([61f1a6d]( https://github.com/es-ude/elastic-ai.creator/commit/61f1a6d60d86b34364dd206f23c53174dc18c8af)) - [object]
- Changed output_QParams to outputs_QParams ([3c2d551]( https://github.com/es-ude/elastic-ai.creator/commit/3c2d551ebb56bcea9c5e4df550e91174b6d8123c)) - [object]
- Split test_forward in linear.py to several tests ([4a4cd46]( https://github.com/es-ude/elastic-ai.creator/commit/4a4cd460d84a85f92a1752c6b57ba2004f832fcb)) - [object]
- Finished the test of linear.py ([cfe1905]( https://github.com/es-ude/elastic-ai.creator/commit/cfe1905e0aa8e19dc372bc2c90e5b996a5c83065)) - [object]
- Modified test_design.py for linear ([696816c]( https://github.com/es-ude/elastic-ai.creator/commit/696816cafa87c2a6bfd75fe277cf0a3f5464ba1f)) - [object]
- Added limitation to make sure precomputation is done before int_forward() ([78df6be]( https://github.com/es-ude/elastic-ai.creator/commit/78df6becd7d7089b86bd9a58e89ae673c57f968e)) - [object]
- Solved bug in intmatmul and improved test_linear ([26407d3]( https://github.com/es-ude/elastic-ai.creator/commit/26407d340c2245ffcd111e9f53bca80561837850)) - [object]
- Improved testing for relu.py ([ae62d67]( https://github.com/es-ude/elastic-ai.creator/commit/ae62d6790a981d442d932c81efeda8085dc875c7)) - [object]
- Simplified test_design of linear_design ([048713b]( https://github.com/es-ude/elastic-ai.creator/commit/048713be0ffebe8da0512f6a93fd03dee96f6108)) - [object]
- Simpilied test for relu ([6001c96]( https://github.com/es-ude/elastic-ai.creator/commit/6001c96a04bbc9c9aa29a8f64bd2dd2efa58186b)) - [object]
- Improved test for math_operations.py ([2d6c5d0]( https://github.com/es-ude/elastic-ai.creator/commit/2d6c5d055c7c84c4b364dd86d0860e4519f2ca90)) - [object]
- Improved test for calculate_quant_params ([f96ed24]( https://github.com/es-ude/elastic-ai.creator/commit/f96ed249c370ae2ca34ab48761c5cd537cc91ef3)) - [object]
- Improved test for quant_utils ([5a043b9]( https://github.com/es-ude/elastic-ai.creator/commit/5a043b9f1f6373aa18b856be95e50cf15bc3391b)) - [object]
- Added test for sequential.py ([fa3b0b6]( https://github.com/es-ude/elastic-ai.creator/commit/fa3b0b68a7f31c4514b4b34cb3a1b4b9a7465fa9)) - [object]
- Moved code from math_operations ([ba1de29]( https://github.com/es-ude/elastic-ai.creator/commit/ba1de292c0c2d14b439138e9dc3278cd2a405ec5)) - [object]
- Renamed all tests files to follow the rule ([002e615]( https://github.com/es-ude/elastic-ai.creator/commit/002e615e6d5bf595c1ace8a58763cbc9f0b76a36)) - [object]
- Added ram template into sequential ([592f31d]( https://github.com/es-ude/elastic-ai.creator/commit/592f31d7a7163cc66e8efae70c10c37cb70f8e4f)) - [object]
- Simquant for avoiding inplace replacement ([22807fa]( https://github.com/es-ude/elastic-ai.creator/commit/22807fac324dd3617dcce89abba5668f1dfd0235)) - [object]
- Residualblock does not call sequential anymore, and fix the self.precomputed ([531ddbd]( https://github.com/es-ude/elastic-ai.creator/commit/531ddbd8893fa078509d600f771a25b54536df24)) - [object]
- Solved problem with standard CNN integer-only quantization ([a48956c]( https://github.com/es-ude/elastic-ai.creator/commit/a48956c447f5524281e733eeaa6081a2d907b141)) - [object]
- Components for separableCNN integer-only inference ([3843c42]( https://github.com/es-ude/elastic-ai.creator/commit/3843c42ed6513c138afae297b2f160151a34311f)) - [object]
- Design and vhdl templates of all components for CNN ([d4c1e69]( https://github.com/es-ude/elastic-ai.creator/commit/d4c1e69c1f922fe86693f76ccef9cee29c3e4600)) - [object]
- Existing bugs for translating model1 to model6 ([431ad26]( https://github.com/es-ude/elastic-ai.creator/commit/431ad26d383ca7ef06275f294fd022caeb045c5c)) - [object]
- Standardized naming format that follows the creator's style ([416d28c]( https://github.com/es-ude/elastic-ai.creator/commit/416d28cd7d6dfc44d816ae8a156d01a6a89f112b)) - [object]
- Bug in depthconv1d's VHDL templates ([e63f25d]( https://github.com/es-ude/elastic-ai.creator/commit/e63f25d7c0c9bad1a4423aafe005c4eba1d86d20)) - [object]
- Bug regarding data range setting in depthconv1d's VDHL templates ([91ea1e7]( https://github.com/es-ude/elastic-ai.creator/commit/91ea1e79c2ab9a2ee31994fad49acdd24bb50408)) - [object]
- Bug in pointconv1dbn's VHDL templates ([d4c62e1]( https://github.com/es-ude/elastic-ai.creator/commit/d4c62e176a554796bbd83956f124f26ec074e4d2)) - [object]
- Bug in addition's design.py ([ad9238b]( https://github.com/es-ude/elastic-ai.creator/commit/ad9238b7d5492bf6a406ea79c731ed3c9d8649f2)) - [object]
- Bug in pointconv1dbn VDHL templates ([ee6792e]( https://github.com/es-ude/elastic-ai.creator/commit/ee6792e576f67e8f15abc4544339014d2b6d2d00)) - [object]
- Bug in conv1d and conv1dbn ([9316abe]( https://github.com/es-ude/elastic-ai.creator/commit/9316abefcbd4107ebccd6fa5bd7bad98db3aa177)) - [object]
- Naming problem in conv1dbn design ([58428a2]( https://github.com/es-ude/elastic-ai.creator/commit/58428a2502a11e8b4d7b2199ffdc660770ddced3)) - [object]
- Bug in avgpooling's design and VHDL templates ([d3a973a]( https://github.com/es-ude/elastic-ai.creator/commit/d3a973a8f7755ac82ac21920696643d65b2b24ca)) - [object]
- Bugs in maxpooling's design and VHDL templates ([fe71389]( https://github.com/es-ude/elastic-ai.creator/commit/fe7138928df8581b74eef286b692c4ae8d8f60fb)) - [object]
- Bugs in separableresidualblock's design and VHDL templates ([673e325]( https://github.com/es-ude/elastic-ai.creator/commit/673e325a1a76c927364bb7b3a47ac7d58f68f64e)) - [object]
- Modified create_makefile to support finding out nested vhd files ([068abb1]( https://github.com/es-ude/elastic-ai.creator/commit/068abb1fef60d6d1f93d63c5f99abdb5fb1be19f)) - [object]
- Fully validated model5 related templates ([9a17044]( https://github.com/es-ude/elastic-ai.creator/commit/9a170442f488784eeda2c61e5a12d8c0dd71e419)) - [object]
- Reorganized the code in the VHDL template for sepresidualblock ([f0fe0ae]( https://github.com/es-ude/elastic-ai.creator/commit/f0fe0aeaeff16285d1f3b1be8503d351b9d88be0)) - [object]
- Residualblock design and VHDL templates and the way to calcutae padding_len ([7d67ee4]( https://github.com/es-ude/elastic-ai.creator/commit/7d67ee46204298dde2907fdc05377dfbda1d7dca)) - [object]
- Add clamp for limiting tmp resultes in linear and conv ([65b3707]( https://github.com/es-ude/elastic-ai.creator/commit/65b370756d589f7cbf27552dd1f3ca6e2dff6077)) - [object]
- Flatten submodules in sep/residualblock ([e8222bd]( https://github.com/es-ude/elastic-ai.creator/commit/e8222bdea7ccf4a6828bd7c689fe5cb75ee40ea1)) - [object]
- Updated makefile due to flattening in sep/residualblock ([6ac7bcb]( https://github.com/es-ude/elastic-ai.creator/commit/6ac7bcbe5620e52bf0f91df465f4b118bf711599)) - [object]
- Updated create_makefile for correct hw simulation ([fed3813]( https://github.com/es-ude/elastic-ai.creator/commit/fed381354e1d2a7ea55fcd70a128d2719278b0cd)) - [object]
- Temporary upload, still failed with LSTM ([f35f8e1]( https://github.com/es-ude/elastic-ai.creator/commit/f35f8e1318fec33b26a9ea8b6506f1d14dbadda4)) - [object]
- Renamed LSTMBlock as StackedLSTM and rewrote data flow ([524bea2]( https://github.com/es-ude/elastic-ai.creator/commit/524bea2170ed6b96572f27684ca785fcefe10686)) - [object]
- Wrote design and vhdl templates for LSTM cell ([7884207]( https://github.com/es-ude/elastic-ai.creator/commit/78842070d8d14cce14d0eae7b34d0e4e1ebc4ada)) - [object]
- Some QParams passing problems ([68cec6b]( https://github.com/es-ude/elastic-ai.creator/commit/68cec6b6641ba506a40c44ea394d254cbc51485f)) - [object]
- Bug in StackedLSTM ([af5bc39]( https://github.com/es-ude/elastic-ai.creator/commit/af5bc39393184773f35be36faf7e0c7d40af3491)) - [object]
- Bug in HardSigmoid and HardTanh ([dfc7f0b]( https://github.com/es-ude/elastic-ai.creator/commit/dfc7f0b87aed8335a73099526d48fffda7af3311)) - [object]
- Modified StackedLSTM further improved the quantized acc ([afe86f6]( https://github.com/es-ude/elastic-ai.creator/commit/afe86f613d98fbe19742be398799672383c3217c)) - [object]
- Bug in HardSigmoid ([cee5e31]( https://github.com/es-ude/elastic-ai.creator/commit/cee5e31ddd90a92b776576eb7380060ef0bdaf6a)) - [object]
- Inserted fakequantization in hardsigmoid forward ([1b3d160]( https://github.com/es-ude/elastic-ai.creator/commit/1b3d1604a638957f22f2dfd90e7b65c6e9bb286c)) - [object]
- Updated naming for inserting gru cell ([dedd21f]( https://github.com/es-ude/elastic-ai.creator/commit/dedd21ff8bd768fe1cadaa2284b54aaa1a89451b)) - [object]
- Merged avgpooling for CNN and Transformer ([3958feb]( https://github.com/es-ude/elastic-ai.creator/commit/3958feb7a8d4542232e4ebd4ce25cb375850ec4e)) - [object]
- Create_design() in matrixmuli ([e27644f]( https://github.com/es-ude/elastic-ai.creator/commit/e27644f393bff4f7d02a06dec9b72dc1ec9aba01)) - [object]
- Str() problem in design of ScaledDotProductAttention ([738cef9]( https://github.com/es-ude/elastic-ai.creator/commit/738cef92f67b5d938ff76ef852e4d889dea58773)) - [object]
- Str() problem in MHA deisgn.py ([80f8478]( https://github.com/es-ude/elastic-ai.creator/commit/80f847815152d5bfd9232d603f7254c92bcf143a)) - [object]
- Str() and naming problem in batchnorm1d ([09c2618]( https://github.com/es-ude/elastic-ai.creator/commit/09c26189af8cb0cc495cd712c2fcced27db4d92d)) - [object]
- Naming probem in encoder, encoder layer ([bc5bb20]( https://github.com/es-ude/elastic-ai.creator/commit/bc5bb20c23a523a10fc6c0ead2ce66c89e3069cc)) - [object]
- Inserted inividual QParams for modified weight ([95f31eb]( https://github.com/es-ude/elastic-ai.creator/commit/95f31eb8b9ecd30e51199960783e1b82a432a3d5)) - [object]
- Bug in SoftmaxLUT ([4df6862]( https://github.com/es-ude/elastic-ai.creator/commit/4df6862367c40fa780eca1ba06622853058e5f1e)) - [object]
- Bug in linear layers in mha ([e7b8f60]( https://github.com/es-ude/elastic-ai.creator/commit/e7b8f60181041dc80be15dd1b27f7f64e39b79e4)) - [object]
- Inserted num_dimensions in RNN ([573ca9a]( https://github.com/es-ude/elastic-ai.creator/commit/573ca9aaa52ee7036368949eadae0be8be8b4a3b)) - [object]
- Bug in RNNLayer ([f38dc85]( https://github.com/es-ude/elastic-ai.creator/commit/f38dc85ef23da266e27593617440f9e65448fad5)) - [object]
- Bug in VDHL templates for linear layers ([3819c0f]( https://github.com/es-ude/elastic-ai.creator/commit/3819c0f1ba8f852fd1286e43b4aea6d30ea187f0)) - [object]
- Bugs regarding makefile ([0fb7a11]( https://github.com/es-ude/elastic-ai.creator/commit/0fb7a11213a150182f03941c969d4c8868cf3f11)) - [object]
- Bug in x_3_addr_width to inner attention ([74086e3]( https://github.com/es-ude/elastic-ai.creator/commit/74086e3c90cc011c00c78b6f23542bd44b5a9b8d)) - [object]
- Bug in matrimulti design and VHDL ([dcc48fd]( https://github.com/es-ude/elastic-ai.creator/commit/dcc48fde0d8762bb98aadc43837629c3e41286a3)) - [object]
- Bug regarding Transformer VHDL generation ([7787396]( https://github.com/es-ude/elastic-ai.creator/commit/7787396706f4847e4f91faeb47ed59dffc3f88ac)) - [object]
- Bug in makefile ([bba042e]( https://github.com/es-ude/elastic-ai.creator/commit/bba042ed9bbd940bec3cf6b13a71a74cde31393f)) - [object]
- Finished the code improvement for RNN ([c8859ac]( https://github.com/es-ude/elastic-ai.creator/commit/c8859ac84da5c1e8a9c1bbad467ab88d7409849b)) - [object]
- Improved CNN-related code ([be02e83]( https://github.com/es-ude/elastic-ai.creator/commit/be02e83fa7ec4294bda656add79e363979445223)) - [object]
- Bug for LSTM-related translation ([e8b6fe5]( https://github.com/es-ude/elastic-ai.creator/commit/e8b6fe5224392140f87aefae193d9bd6a621ac5e)) - [object]
- Removed all addr for activation functions in LSTM ([1c01cdf]( https://github.com/es-ude/elastic-ai.creator/commit/1c01cdffae45476794589f63b45d7ec3cd722837)) - [object]
- Finished HardTanh VHDL templates for integer-only quantization ([445a4a4]( https://github.com/es-ude/elastic-ai.creator/commit/445a4a43524dd61b5804686baca5f6ea01464978)) - [object]
- Concatenate VHDL template ([e726957]( https://github.com/es-ude/elastic-ai.creator/commit/e7269576bd147547b28b114474ac67616ed0ade1)) - [object]
- Hadamardproduct VHDL templates ([14817b6]( https://github.com/es-ude/elastic-ai.creator/commit/14817b68df4eddaa9b2bed4372ab125e2e957720)) - [object]
- Bug in Linear translation setting ([41ec55d]( https://github.com/es-ude/elastic-ai.creator/commit/41ec55d3bb8ecd06df099faac231bfaf1ed3753c)) - [object]
- Naming bug in LSTM ([3964f11]( https://github.com/es-ude/elastic-ai.creator/commit/3964f11a954684f29180e72980ecdbffd946d5ad)) - [object]
- Bug in LSTM cell's design and VHDL ([8cd4037]( https://github.com/es-ude/elastic-ai.creator/commit/8cd40375eaa763e67f96f34b98c4ec6fc37bff6a)) - [object]
- Bug in LSTM Layer VHDL ([4333e22]( https://github.com/es-ude/elastic-ai.creator/commit/4333e2264bd845addf7f6d1f37c8755f93ab2fac)) - [object]
- Bug in stackedrnn design and VHDL files ([f58e0a4]( https://github.com/es-ude/elastic-ai.creator/commit/f58e0a4f48c7ad380bfd58512177ddd2f6d06782)) - [object]
- Bug of naming in stakedrnn ([3b7a066]( https://github.com/es-ude/elastic-ai.creator/commit/3b7a06606f3241a031ef59201beba119af11675f)) - [object]
- Bug in concatenate design, regarding m_q_2 is int(0) ([1e627ca]( https://github.com/es-ude/elastic-ai.creator/commit/1e627ca6dc182bca5868d1011dc4cab1f554fe29)) - [object]
- Bug regarding nt(np.ceil(np.log2(self._m_q_1))) ([99c7506]( https://github.com/es-ude/elastic-ai.creator/commit/99c7506d6df96339b513df26b3fe88b4b2dd341d)) - [object]
- Inserted noise in LSTM cell ([f3c3683]( https://github.com/es-ude/elastic-ai.creator/commit/f3c3683006f1b64e910f9b2d84629ff11ef7caf3)) - [object]
- Problem in scaling_M ([fbc3809]( https://github.com/es-ude/elastic-ai.creator/commit/fbc380924b60a07ae73f38ebb1a61ecd60a4c618)) - [object]
- Relaxing bit-width limits in int_mac ([66f3cb3]( https://github.com/es-ude/elastic-ai.creator/commit/66f3cb3709d55f9ce4508b9d0da271ec8b607da4)) - [object]
- Updated VHDL templates and design python files for the SepConv1dBN component ([2446326]( https://github.com/es-ude/elastic-ai.creator/commit/244632617ac5747ef76874c3d7b934414127f9b3)) - [object]
- Modified the problem with shortcut in sepresidualblock ([e00f45e]( https://github.com/es-ude/elastic-ai.creator/commit/e00f45eb25a11a050a1ebef4aa0a28494fd19191)) - [object]
- Updated the design and VHDL templates for FusedSepResidualBlock ([82049a1]( https://github.com/es-ude/elastic-ai.creator/commit/82049a18f89b595ecc7f2d510fb5ddbb7b733a38)) - [object]
- Connect problem with fusedsepresidualblock ([fb88142]( https://github.com/es-ude/elastic-ai.creator/commit/fb88142a9c072baa5535bd449917eb7193f1c629)) - [object]
- Connection problem in the VHDL templates in fusedsepresidualblock ([5c74ea4]( https://github.com/es-ude/elastic-ai.creator/commit/5c74ea4ed89ef6cb2dad20ee7ac17353924d70f2)) - [object]
- Removed extra comma ([03dfd8c]( https://github.com/es-ude/elastic-ai.creator/commit/03dfd8ce6a0a3be44aca78fa08ab2eea9112a86c)) - [object]
- Problem in shortcut design in the SepResidualBlock ([f008d00]( https://github.com/es-ude/elastic-ai.creator/commit/f008d008751ac28e2d316e0cd48b8c3c5ea82534)) - [object]
- Assign a default value to m_q ([ea51ee7]( https://github.com/es-ude/elastic-ai.creator/commit/ea51ee7ce33a17263d3c1b393b2bb2d1f75cebd7)) - [object]
- Bug in ffn_tb.tpl.vhd ([e9ce33d]( https://github.com/es-ude/elastic-ai.creator/commit/e9ce33d08fd935832c1e4bdbe8fe82ae454baf57)) - [object]
- Updated naming assignment rule in VHDL templates ([ea31b9b]( https://github.com/es-ude/elastic-ai.creator/commit/ea31b9b684d5a8a28e0a29baf7b452df29f0bd22)) - [object]
- Inserted ffn_dim parameter ([827c6aa]( https://github.com/es-ude/elastic-ai.creator/commit/827c6aafd2fff6d48640bae70af3f7bf8ed49956)) - [object]
- Bug in addition's VHDL templates ([45b2487]( https://github.com/es-ude/elastic-ai.creator/commit/45b248772a069edd30f51fb4fe378fbf00730af2)) - [object]
- Bug in addition and avgpoo ([de67976]( https://github.com/es-ude/elastic-ai.creator/commit/de67976b2c4188382a4ce463152fc68a4a9e5a6b)) - [object]
- Introduce error_threshold in scaling_M and apply to addition() ([8b9dd41]( https://github.com/es-ude/elastic-ai.creator/commit/8b9dd4104cceae0126abb1d1b20e12d621ee9ea0)) - [object]
- Updated softmaxLUT ([ea50d9e]( https://github.com/es-ude/elastic-ai.creator/commit/ea50d9ed6c8bfdf0cca1a52f50daf70a0ee133bb)) - [object]
- Bug in LSTM layer ([fd3ee63]( https://github.com/es-ude/elastic-ai.creator/commit/fd3ee63efdd3efc4e442906c7793996c862b2895)) - [object]
- Nanming bug in LSTM layer ([67bddc2]( https://github.com/es-ude/elastic-ai.creator/commit/67bddc210edc85e0ef5f23e65a253750884c6f89)) - [object]
- Bug in linearrelu ([6c065ee]( https://github.com/es-ude/elastic-ai.creator/commit/6c065ee9e861f8c55da4120a0dce5a01be0873d9)) - [object]
- Split two types of avgpooling ([6ccca7d]( https://github.com/es-ude/elastic-ai.creator/commit/6ccca7d5ed75dfb4b2e74035040d597ce233b6f7)) - [object]
- Toward-0 truncate problem in HardSigmoid ([8b7936c]( https://github.com/es-ude/elastic-ai.creator/commit/8b7936ce3253e0b0a6c925cc3072bb6f387382c6)) - [object]
- Bug in concatenate VHDL templates ([8ffa355]( https://github.com/es-ude/elastic-ai.creator/commit/8ffa355d95e86f19a4ed53d61970961d0e9aa114)) - [object]
- Naming in concatenate VHDL ([5740c46]( https://github.com/es-ude/elastic-ai.creator/commit/5740c46cb88a44fbdca968142b6eba7076128cc4)) - [object]
- Updated linearrelu ([fc76c3b]( https://github.com/es-ude/elastic-ai.creator/commit/fc76c3b8ec9b980bdd7d41d4e247424bbcb22fe6)) - [object]
- Bug in LSTM cell ([a6ff3c5]( https://github.com/es-ude/elastic-ai.creator/commit/a6ff3c59ad293268e3c7740e9ff6b88f540e0b52)) - [object]
- Unitest errors and update pre-commit configuration ([abc6552]( https://github.com/es-ude/elastic-ai.creator/commit/abc65522f76546e45df710fcad998f51de91d822)) - [object]
- Delete useless prints ([001bfcf]( https://github.com/es-ude/elastic-ai.creator/commit/001bfcf3f7eded5979d128162634a77c13037e70)) - [object]
- Stacked RNN now assign zero-point of h and c to the rnn layer ([d640127]( https://github.com/es-ude/elastic-ai.creator/commit/d640127a89c9e57ab5b644c91cc22505748972e0)) - [object]
- Some code refactoring ([b2a8565]( https://github.com/es-ude/elastic-ai.creator/commit/b2a8565dffd5392522d315082cef48a4d612c3ae)) - [object]
- Small issues, sso LSTM can run up to 200MHz with Unroll factor of 10 on S50 ([cc8b04c]( https://github.com/es-ude/elastic-ai.creator/commit/cc8b04c314f801dd875f40faa1908950c6c9eb88)) - [object]
- Add clamping logic on templates for LSTM ([08aa9aa]( https://github.com/es-ude/elastic-ai.creator/commit/08aa9aa7a0b8c9c0a68f622d846600b2155f0467)) - [object]
- Remove useless comments ([f817ba5]( https://github.com/es-ude/elastic-ai.creator/commit/f817ba5cf527df52bfebb4dd5d92eb779313ecaf)) - [object]
- Speedup SoftmaxLUT's int_forward() by converting dict to tensor ([53c5c97]( https://github.com/es-ude/elastic-ai.creator/commit/53c5c97c3a76b27440b557f8f07b2134bcb105a5)) - [object]
- Modified ghdl version control ([b84ca29]( https://github.com/es-ude/elastic-ai.creator/commit/b84ca29718d2b6c1454b3aefd72bc57cfa4f7e09)) - [object]
- Revert default linear layer use distributed RAM ([812db90]( https://github.com/es-ude/elastic-ai.creator/commit/812db90af9628d09142f858ceecd3eaf96916dea)) - [object]
- Resolve pipeline template flag bug ([e7e8769]( https://github.com/es-ude/elastic-ai.creator/commit/e7e8769b4012e2907b9e428df1854b38abe950b3)) - [object]
- Opt timing ([dace45d]( https://github.com/es-ude/elastic-ai.creator/commit/dace45d277441dfb4476b177fb2b5e0760723144)) - [object]
- Length of multi-value rom. ([23e6680]( https://github.com/es-ude/elastic-ai.creator/commit/23e6680e8fdb675850ddbc627a314dd7e30b2911)) - [object]
- Length error rom gen ([3822666]( https://github.com/es-ude/elastic-ai.creator/commit/3822666c9d33c3ee37093b6d15d19a0427ac9fec)) - [object]
- Updated requantizer in addition MPQ ([d044f44]( https://github.com/es-ude/elastic-ai.creator/commit/d044f440ada65eed963f344386fd96a7cb8ed86b)) - [object]
- Inserted params passing for module ([70ece19]( https://github.com/es-ude/elastic-ai.creator/commit/70ece19c1c3d1b34110a2fa628d1ad853c6b2ad2)) - [object]
- Updated the quant_bits assignment way for upper module in Transformer ([a2563c8]( https://github.com/es-ude/elastic-ai.creator/commit/a2563c849e8ec4124bcb34784c8e82b14218f869)) - [object]
- Cleaned design for VHDL templates supporting MPQ ([5802090]( https://github.com/es-ude/elastic-ai.creator/commit/5802090ba6c53d25c4140ad4abc60a7b5117ead5)) - [object]
- Removed linear_1d to focus on MPQ for Transformer ([e225bfc]( https://github.com/es-ude/elastic-ai.creator/commit/e225bfcae10a3a0948be9419ad6a72cc8a21a03b)) - [object]
- Added MPQ support for linear's VHDL ([2701b67]( https://github.com/es-ude/elastic-ai.creator/commit/2701b67c33e59b649095421e2a5ef9ac6617419b)) - [object]
- Inserted MPQ support for BatchNorm1d's VHDL ([fde60c5]( https://github.com/es-ude/elastic-ai.creator/commit/fde60c5f735f4c664867b1ed6bc9e78b6f32b672)) - [object]
- Bug in port() in Addition and AVGpooling's design ([33cfcba]( https://github.com/es-ude/elastic-ai.creator/commit/33cfcbab1801394520d7a101dea5a05a18c75bfb)) - [object]
- Bug in port() in MatrixMulti's design ([2fd56c8]( https://github.com/es-ude/elastic-ai.creator/commit/2fd56c89171261b7946300660b1e3e53268dfea5)) - [object]
- Added MPQ support for ReLU's VHDL ([fe1e00e]( https://github.com/es-ude/elastic-ai.creator/commit/fe1e00e061ab9d9d2aee6858c1371d6b4a529960)) - [object]
- Added MPQ support for softmax's VHDL ([56039de]( https://github.com/es-ude/elastic-ai.creator/commit/56039deeaa0944e46420ca0faa0a33982c9631b7)) - [object]
- Simplified params passing in design of linear ([b8f1300]( https://github.com/es-ude/elastic-ai.creator/commit/b8f13000c219668ae7703e291eb7573f8b26700d)) - [object]
- Simplified params passing in design of addition ([6e1aab2]( https://github.com/es-ude/elastic-ai.creator/commit/6e1aab2cfb59076c0e8e67ff0dd860db1aa1fb66)) - [object]
- Simplified params passing in design of avgpooling1dflatten ([4168e72]( https://github.com/es-ude/elastic-ai.creator/commit/4168e72764b2f6168404552ae6700a7129891cf8)) - [object]
- Simplified params passing in design of batchnorm1d ([d1facdb]( https://github.com/es-ude/elastic-ai.creator/commit/d1facdbb70ae69211e888f108a027c877379014f)) - [object]
- Simplified params passing in design of matrixmulti ([b8e03cb]( https://github.com/es-ude/elastic-ai.creator/commit/b8e03cb8400245fcb17f60a0e5b31dbe16b22c83)) - [object]
- Simplified params passing in design of softmax ([c2fa9e7]( https://github.com/es-ude/elastic-ai.creator/commit/c2fa9e70966be361996f7b3255956e60a7e59af0)) - [object]
- Added MPQ support for scaleddotproductattention ([5c0bf06]( https://github.com/es-ude/elastic-ai.creator/commit/5c0bf067836c75347f78ca90e413683b17fc4c05)) - [object]
- Added MPQ support for mha ([b1d25cb]( https://github.com/es-ude/elastic-ai.creator/commit/b1d25cbb0f87597ec2ba3be277118fe37a13aca5)) - [object]
- Added MPQ support for encoderlayer and ffn ([b4c5876]( https://github.com/es-ude/elastic-ai.creator/commit/b4c5876bbf3c261260cee37fa0e340b389cf069b)) - [object]
- Rebuild sequential for MPQ ([6e1a0cb]( https://github.com/es-ude/elastic-ai.creator/commit/6e1a0cb7d997fb4e4f000ad87169388139ca2cbc)) - [object]
- Some bug for MPQ Transformer GHDL simulation ([c6b0fa7]( https://github.com/es-ude/elastic-ai.creator/commit/c6b0fa7647fc721f50fdfa2393010ca20d77142f)) - [object]
- Bug in avgpoolingflatten's VHDL, served only for Transformer ([f089568]( https://github.com/es-ude/elastic-ai.creator/commit/f089568caa105058d21966dd53e82516076e3017)) - [object]
- Updated avgpoolingflatten for Transformer MPQ ([4a6dee0]( https://github.com/es-ude/elastic-ai.creator/commit/4a6dee0d710dbf97af009028a9d1433ba24bbac7)) - [object]
- Updated code for different MPQ strategy ([71df4c2]( https://github.com/es-ude/elastic-ai.creator/commit/71df4c26dc23b0ca6ce3de2c9dc866245fef216f)) - [object]
- Removed _init_Qparams() ([be4aef4]( https://github.com/es-ude/elastic-ai.creator/commit/be4aef4a2357684952d94239c8ff2d28ff7a413a)) - [object]
- Saved quant_bits in MPQparams for MPQ ([c6cc499]( https://github.com/es-ude/elastic-ai.creator/commit/c6cc499e75a98ee65aff91275449e341225fbd38)) - [object]
- Updated create_design for supporting MPQ ([0255160]( https://github.com/es-ude/elastic-ai.creator/commit/02551607b077f2495a5538242b02f8db21388f8d)) - [object]
- Bug in MPQ addition vhdl ([98447b0]( https://github.com/es-ude/elastic-ai.creator/commit/98447b0a196d66fdeec83f4623269582749236ef)) - [object]
- Bug in FFN vhdl for MPQ ([58caae8]( https://github.com/es-ude/elastic-ai.creator/commit/58caae8282d0c2d574f0fee4168cac5b24218fab)) - [object]
- Softmax supports MPQ ([94cb5cc]( https://github.com/es-ude/elastic-ai.creator/commit/94cb5cc54dfde4e8b419e5978e395a1bb71db2c7)) - [object]
- Updated quantization on LayerNorm, not tested ([3efac60]( https://github.com/es-ude/elastic-ai.creator/commit/3efac60a202d0ea8ecb95e0dcc098a7be11b2076)) - [object]
- Converted QParams back for only supporting uniform quantization bitwidth ([a549ec4]( https://github.com/es-ude/elastic-ai.creator/commit/a549ec45ec99472a878dff94d12f897d6bd1d65a)) - [object]
- Bug in softmaxLUT's inputs2_QParams's quantization bitwidth under inheritance quant mode ([cd2bfd4]( https://github.com/es-ude/elastic-ai.creator/commit/cd2bfd488aa5f70a5aec3bcb351912e7f761c4d6)) - [object]
- Update firmware_env5 v1 expected skeleton for current address mapping ([03f122e]( https://github.com/es-ude/elastic-ai.creator/commit/03f122e55ce29b7f2df6a8650a2769a6436e15a8)) - [object]
- Wire integer/MPQ sequentials to shared builder ([0588b52]( https://github.com/es-ude/elastic-ai.creator/commit/0588b5270121169866b67516017cb448f84e1aea)) - [object]
- Add_edges now supports args with equal src ([982e0a9]( https://github.com/es-ude/elastic-ai.creator/commit/982e0a9208e7b8d09c63234b2bb976caddf44301)) - [object]
- Build docs after moving source files to `src/` ([b20727f]( https://github.com/es-ude/elastic-ai.creator/commit/b20727f7ec124e59f2f661c5f837cbe1e9d787d4)) - [object]
- Go back to non circ buff implementation ([498c3db]( https://github.com/es-ude/elastic-ai.creator/commit/498c3db182762f5fbad09e02bfc2ff2715dcf981)) - [object]
- Wire up clocked_combinatorials correctly ([cea3f56]( https://github.com/es-ude/elastic-ai.creator/commit/cea3f56150f8e416abefa0fb293d919313c82009)) - [object]

### Refactor

- Clean up some left over imports ([1a96d3a]( https://github.com/es-ude/elastic-ai.creator/commit/1a96d3a8baf2658df0b52fb94b8245a98314c1a0)) - [object]
- Use new type annotation style ([0084b33]( https://github.com/es-ude/elastic-ai.creator/commit/0084b3364fe678d7970b835adbe6643ece619721)) - [object]
- Reorganize plugin code into subpackage ([d05f726]( https://github.com/es-ude/elastic-ai.creator/commit/d05f726a57ccdef1e8ce2a8d02dce37cd6825cb3)) - [object]
- Use function_dispatch module for ir2vhdl/verilog ([c56246d]( https://github.com/es-ude/elastic-ai.creator/commit/c56246d3699281f77759ffffdffc70f6d08c9d3a)) - [object]
- Use new function_dispatch instead of function_utils ([1d105bc]( https://github.com/es-ude/elastic-ai.creator/commit/1d105bcfe83c934108dfd51a4d65c06557d286c4)) - [object]
- Use function_dispatch instead of old module ([362cdc1]( https://github.com/es-ude/elastic-ai.creator/commit/362cdc101f044a48d699348cdadc51019f7c1656)) - [object]
- Use function_dispatch ([4380801]( https://github.com/es-ude/elastic-ai.creator/commit/4380801005527ed3a22518df51a33fb918e9a1e0)) - [object]
- Move language generation to separate submodule ([a9d3a03]( https://github.com/es-ude/elastic-ai.creator/commit/a9d3a03e6b005f1255228be1dd71a27c95109f0f)) - [object]
- Move ir shape inference in experimental ([3e16239]( https://github.com/es-ude/elastic-ai.creator/commit/3e162392fb68a68081804e5e8b41a38f9892f5a1)) - [object]
- Introduce shared SequentialDesignBuilder ([c1e58ba]( https://github.com/es-ude/elastic-ai.creator/commit/c1e58ba10b8746cf2e289ae1958c44e14ff1b80c)) - [object]
- Remove integer quant related code from quantization independent sequential ([8013140]( https://github.com/es-ude/elastic-ai.creator/commit/80131403447a53980adff009dabc863c31d1ac51)) - [object]
- Move integer quantization specific sequential model in the integer package ([44c6f0e]( https://github.com/es-ude/elastic-ai.creator/commit/44c6f0ed417e0b32916ae3155e95b8257d752e99)) - [object]
- Remove unused and redundant rom module ([b313ed3]( https://github.com/es-ude/elastic-ai.creator/commit/b313ed35886ed89056dd6b2926c67fabad845481)) - [object]
- Fix type annotations for `creator.ir` ([de33b3d]( https://github.com/es-ude/elastic-ai.creator/commit/de33b3dafac04b8a74471fb2157a9ed1571f136d)) - [object]
- Improve reusability and use ir code patterns ([4851e88]( https://github.com/es-ude/elastic-ai.creator/commit/4851e883a637d33483e44ae6381b6d300e87d72f)) - [object]

### Style

- Removed unused import and files ([b9f8221]( https://github.com/es-ude/elastic-ai.creator/commit/b9f8221b56fc0ed9047f77a65f805d1eff482bee)) - [object]
- Cleaned code for Ram ([657ca49]( https://github.com/es-ude/elastic-ai.creator/commit/657ca49fc6e7f5392063576e9f8e2921d1882049)) - [object]
- Removed dtype and drange check after quantizeProcess ([66b28d4]( https://github.com/es-ude/elastic-ai.creator/commit/66b28d4ea7aff31d3b47bbbcefae224d9c3daa00)) - [object]
- Simplified _quant_weight() and _quant_bias() ([d4eb763]( https://github.com/es-ude/elastic-ai.creator/commit/d4eb7632719c5b65169b650c92a05e2be696dc17)) - [object]
- Simplified bitshifting-related code in precompute() in linear ([e4443f5]( https://github.com/es-ude/elastic-ai.creator/commit/e4443f5d04732c85d513f79e325185ff07a0df78)) - [object]
- Removed unuse code ([421f859]( https://github.com/es-ude/elastic-ai.creator/commit/421f8591eee8914a4625a770e610ed284a197549)) - [object]

### Test

- Mark hardware VHDL test as simulation ([a076514]( https://github.com/es-ude/elastic-ai.creator/commit/a0765147af65f3d5ca76e139f316f72bee167859)) - [object]
- Make ROM code assertions robust to generated content ([c024256]( https://github.com/es-ude/elastic-ai.creator/commit/c02425618a2dc509431365555b335db42ca1ea20)) - [object]
- Fix a code gen tests failing from out of date expected code ([f63f533]( https://github.com/es-ude/elastic-ai.creator/commit/f63f533d3f7cfa8d9226ad113379658efbad20c3)) - [object]
- Use testing.StreamInterface in grouped filter test ([92fd293]( https://github.com/es-ude/elastic-ai.creator/commit/92fd2932220e6c9be8e7ffbd951bf628342c4a00)) - [object]

## 0.67.0 - 2026-01-21

[0a05b48](0a05b4872da4845078f8482e7339f9d5e00344c7)...[9a8db3c](9a8db3c81c58c5ce8d096f828028ed0e51fd5167)
...
- Bump version to v0.67.0 ([9a8db3c]( https://github.com/es-ude/elastic-ai.creator/commit/9a8db3c81c58c5ce8d096f828028ed0e51fd5167)) - [object]
