...
## v0.61.0 - 2025-02-20
#### Bug Fixes
- **(HwFunctionId)** fix typo - (13ebdfb) - Lukas Einhaus
- **(ci)** correct command for building docs - (0344afd) - Lukas Einhaus
- **(docs)** correct link to repo in html theme - (dabecc1) - Lukas Einhaus
- **(ghdl-test-runner)** provide useful error message for <py311 - (940ccfe) - Lukas Einhaus
- **(ir)** do not auto create __init__ from IrDataMeta by default - (6d4b87d) - Lukas Einhaus
- **(ir)** error from IrDataMeta if inheriting class has no annotations - (42fbea2) - Lukas Einhaus
- **(ir)** exclude required fields for node.attributes | dict() - (5ef4802) - Lukas Einhaus
- **(plugin)** do not raise error on unexpected plugin fields - (e3d4445) - Lukas Einhaus
- **(skeleton_id)** properly deal with nested folders - (79e5f9e) - Lukas Einhaus
- use the pytest tmp_dir fixture to avoid creating files when running simulations - (06dbd62) - Julian Hoever
- remove incorrect use of Self type variable - (0f8a738) - Lukas Einhaus
- fix several minor errors that were discoverd by mypy - (5645da0) - Lukas Einhaus
#### Build system
- **(devenv)** add kroki plugin to antora to build diagrams - (380ab02) - Lukas Einhaus
- **(pyproject)** add hypothesis for testing - (a0f5eba) - Lukas Einhaus
- **(versioning)** use cog instead of cliff for changelogs - (eabf4e1) - Lukas Einhaus
- add VUnit to testing dependencies - (8bf1572) - Lukas Einhaus
- drop support for py 3.10 and move to 3.11 - (284d476) - Lukas Einhaus
- fix includes for hatch - (58c8f8e) - Lukas Einhaus
- use git to dynamically extract version - (223a13e) - Lukas Einhaus
- autoupdate uv.lock - (2a59a5c) - Lukas Einhaus
- add plugins namespace to pytest discovery - (fbf5c07) - Lukas Einhaus
- update ruff version and uv.lock file - (9229e30) - Lukas Einhaus
- add uv.lock and set .python-version to 3.10 - (533add1) - Lukas Einhaus
- replace poetry by uv - (47d9538) - Lukas Einhaus
#### Continuous Integration
- **(devenv)** use devenv from unstable channel v1.4 - (d7ace47) - Lukas Einhaus
- **(devenv)** remove broken task dependencies - (111ab50) - Lukas Einhaus
- **(devenv)** use devenv to run all tests in ci - (8220954) - Lukas Einhaus
- **(docs)** deploy self-contained html to PR for preview - (03eb5ba) - Lukas Einhaus
- check types with mypy - (df71257) - Lukas Einhaus
- run ghdl testbenches for plugins - (6b6a046) - Lukas Einhaus
- build docs - (fe0b992) - Lukas Einhaus
- fix pypi publish gh-action version - (0e18cb8) - Lukas Einhaus
- remove beautify pipeline step - (e2c9faf) - Lukas Einhaus
- correct name in workflow uploading to github - (22a7867) - Lukas Einhaus
#### Documentation
- **(contribution)** improve readability (hopefully) - (7be9894) - Lukas Einhaus
- **(function_utils)** fix incorrect class names in examples - (99968b8) - Lukas Einhaus
- **(ir)** explain the core concepts of ir - (1d54159) - Lukas Einhaus
- **(ir)** explain how to annotate fields - (4176c58) - Lukas Einhaus
- **(ir2vhdl)** add previously missing ir2vhdl.adoc file - (05606c7) - Lukas Einhaus
- update autogenerated docs - (3ce97f4) - Lukas Einhaus
- add GitHub repository link to documentation header - (78d110d) - Brijeshthummar02
- extend ir2vhdl documentaion - (c5eafde) - Lukas Einhaus
- Clarified installation via PyPi - (037d0e2) - Christopher Ringhofer
- fix missing table end - (6ec2343) - Lukas Einhaus
- do not build api docs for plugins - (7de975d) - Lukas Einhaus
- fix asciidoc refs and formatting in docstrings - (b6ff358) - Lukas Einhaus
- improve wording in ghdl test-runner docs - (868a51f) - Lukas Einhaus
- improve formatting - (1c81917) - Lukas Einhaus
- fix wrong package name in install command - (22426ab) - Lukas Einhaus
- move dev docs from readme into contribution.md - (3a56226) - Lukas Einhaus
- explain commit/pr policy in contribution guide - (e04630c) - Lukas Einhaus
- Listed deprecated modules and those in development - (9c7c12c) - Christopher Ringhofer
- Added preliminary documentation for creating new modules - (1d47f05) - Christopher Ringhofer
- started documenting supported features - (91c5167) - Christopher Ringhofer
- specified required versions for dev dependencies - (3b39f0e) - Christopher Ringhofer
#### Features
- **(function-utils)** extend signature of FunctionDecorator - (b972cf4) - Lukas Einhaus
- **(ir)** support pattern based graph rewriting - (79dc9f4) - Lukas Einhaus
- **(ir)** add `get_empty_copy` fn for `ir.Graph` - (1e28c14) - Lukas Einhaus
- **(ir)** add `find_subgraph` - (97e84ec) - Lukas Einhaus
- **(ir)** support decorating methods as required fields - (569d0b2) - Lukas Einhaus
- **(ir)** implement __eq__ for nodes/edges attributes of Graphs  - (47e37dd) - Lukas Einhaus
- **(ir)** support overriding registered type handlers - (fec5313) - Lukas Einhaus
- **(ir)** turn ir.Graph into a IrData object - (8d44f1b) - Lukas Einhaus
- **(ir)** add FilterParameters and Shape - (09443f4) - Lukas Einhaus
- **(ir2torch)** support loading model state dicts - (a1eacaf) - Lukas Einhaus
- **(ir2torch)** make ir2torch a lowering pass - (74942a4) - Lukas Einhaus
- **(ir2torch)** add Ir2Torch and support linear+relu - (df47f74) - Lukas Einhaus
- **(ir2vhdl)** add basic test runner for vunit testbenches - (b6b48ee) - Lukas Einhaus
- **(ir2vhdl)** create static files from plugins - (ee23798) - Lukas Einhaus
- **(ir2vhdl)** adds support for ir2vhdl plugins - (3239641) - Lukas Einhaus
- **(nn-qgrad)** added momentum and weight decay - (44a0732) - Leo Buron
- **(nn-qgrad)** added sgd (#429) - (6d74b48) - Leo Buron
- **(plugin)** make plugin loader more flexible - (aae96e6) - Lukas Einhaus
- **(plugins)** make the plugin system more intuitive - (ac13c15) - Lukas Einhaus
- **(qgrads)** added parametrization and module quantization - (4e551e9) - Leo Buron
- **(qgrads)** add support for execution on specific devices - (2964e62) - Leo Buron
- **(torch2ir)** support simple torch 2 ir conversion w/o model state - (e06e028) - Lukas Einhaus
- **(vhdl)** add HwFunctionIdUpdater - (09aef74) - Lukas Einhaus
- **(vhdl-plugins)** add a new skeleton - (e4bc616) - Lukas Einhaus
- **(vhdl-plugins)** add striding shift register - (7f25038) - Lukas Einhaus
- **(vhdl-plugins)** add sliding window - (d22336e) - Lukas Einhaus
- **(vhdl-plugins)** add shift register - (6b5a5b2) - Lukas Einhaus
- **(vhdl-plugins)** add padding - (b71a83a) - Lukas Einhaus
- **(vhdl-plugins)** add counter - (7e04f9a) - Lukas Einhaus
- **(vhdl-plugins)** add middleware - (1c7b82b) - Lukas Einhaus
- improve typing and allow to pass pathlib.Path as working_dir - (79c6115) - Julian Hoever
- improve error handling when loading plugins - (924d63c) - Lukas Einhaus
- discover/compile/run/log vhdl testbenches from plugins - (c485099) - Lukas Einhaus
#### Miscellaneous Chores
- **(build)** configure mypy - (32cd72e) - Lukas Einhaus
- **(devenv)** update devenv.lock - (09dd5f1) - Lukas Einhaus
- **(devenv)** remove statements to run py311 to generate docs - (0841dc3) - Lukas Einhaus
- **(devenv)** update devenv.lock - (640a01e) - Lukas Einhaus
- **(devenv)** add devenv tasks to run all checks in parallel - (cc17635) - Lukas Einhaus
- **(devenv)** add jj/git/pikchr - (9c8ebdc) - Lukas Einhaus
- **(devenv)** support vivado and add options to ghdl module - (0ddb41f) - Lukas Einhaus
- **(docs)** remove and ignore autogenerated files - (4a29ee9) - Lukas Einhaus
- **(docs)** change docs theme to pydata - (9f23518) - Lukas Einhaus
- **(docs)** move docs source do `docs/` and adjust some docstrings - (1325b12) - Lukas Einhaus
- **(docs)** replace antora/asciidoc by sphinx/markdown - (39b38d4) - Lukas Einhaus
- **(ghdl-tb-runner)** remove runner and utils - (fa268cf) - Lukas Einhaus
- **(github)** add issue and pr templates - (f9fe969) - Lukas Einhaus
- **(ir)** print class name in instead of class in IrData repr - (168f45c) - Lukas Einhaus
- **(plugins)** add bash scripts to help creating new plugins - (a1b7f4a) - Lukas Einhaus
- **(pyproject)** add wavedrom extension for sphinx - (4e3514d) - Lukas Einhaus
- **(pytest)** add new 'slow' marker - (4da2334) - Lukas Einhaus
- use tach to adhere to architecture - (9c845ae) - Lukas Einhaus
- include tests in ruff linting - (9e3e38a) - Lukas Einhaus
- rename FunctionDecoratorFactory to FunctionDecorator - (85464cf) - Lukas Einhaus
- lint unorganized imports - (f31196a) - Lukas Einhaus
- use importlib mode for pytest to avoid errors about missing __init__ files in test folders - (687f0c3) - Julian Hoever
- add basic support for devenv - (bbb3073) - Lukas Einhaus
- add basic support for devenv - (7df56a1) - Lukas Einhaus
#### Refactoring
- **(ir)** expose nodes/edges via ir data fields - (d861c53) - Lukas Einhaus
- **(ir)** clean up type hints - (8047010) - Lukas Einhaus
- **(ir)** add iterator methods to ir.Graph - (dd6f077) - Lukas Einhaus
- **(ir)** add iter_edges method to GraphDelegate for consistency - (87313b7) - Lukas Einhaus
- **(ir2vhdl)** move ir2vhdl to dedicated subpackage - (65034d5) - Lukas Einhaus
- **(qgrads)** refactored interface for autograd and mathoperations (#456) - (e745f3b) - Leo Buron
- **(test)** put ir graph tests into same module - (d1441e6) - Lukas Einhaus
- **(tests)** move tests from the elasticai.creator source tree to the tests folder to maintain a consistent tests location - (7ea58c4) - Julian Hoever
- **(tests)** move tests from the Elasticai Creator source to the tests folder to maintain a consistent location for tests - (b0b892f) - Julian Hoever
- **(utils)** move ghdl_msg parsing to its own module - (124cad1) - Lukas Einhaus
- **(vhdl-mac)** move fixed point mac to nn.fixed_point - (21f5fd6) - Lukas Einhaus
- use more a precise return type for the create_design function - (079328a) - Julian Hoever
- Removed test_utils - (ff3cd5a) - Christopher Ringhofer
- automatically fix linted problems - (3862f21) - Lukas Einhaus
- renamed tests folder to test_utils and moved to elasticai/creator - (e2b86a8) - Christopher Ringhofer
#### Style
- **(ir)** improve type hints - (c0701d0) - Lukas Einhaus
- apply unsafe ruff fixes to tests - (c588232) - Lukas Einhaus
- apply safe ruff fixes to tests - (ed2ec86) - Lukas Einhaus
- make imports in __init__.py files explicit - (60149d1) - Lukas Einhaus
- apply safe ruff format for imports - (f42651e) - Lukas Einhaus
- improve formatting and add missing text in workflows - (11b0160) - Lukas Einhaus
- fix formatting using ruff - (faf97cb) - Lukas Einhaus
#### Tests
- **(nn)** add test cases for linear and batchnormed linear layer - (31a19f1) - Andreas Erbslöh
- **(system)** remove broken echo server test - (b0f8e72) - Lukas Einhaus
- **(vhdl)** pass command line args to vunit test facade - (d36a94e) - Lukas Einhaus
- fix torch warnings resulting from using the deprecated torch.range function - (2225375) - Julian Hoever
- fix torch warnings during test runs - (4022702) - Julian Hoever
