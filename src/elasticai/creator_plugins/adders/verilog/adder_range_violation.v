...
//                  IS_SIGNED   --> Is the result signed or unsigned
//////////////////////////////////////////////////////////////////////////////////
...
module ADDER_RANGE_VIOLATION#(
    ...
    assign UPPER_LIMIT = (IS_SIGNED) ? (!A[BITWIDTH-'d1] && |extracted[0]) : |extracted[1];
    assign DOWNER_LIMIT = (IS_SIGNED) ? (A[BITWIDTH-'d1] && ~&extracted[2]) : 1'd0;
