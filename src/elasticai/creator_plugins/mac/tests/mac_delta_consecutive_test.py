...
def test_mac_delta_consecutive_dsp(
    ...
    cocotb_test_fixture.add_srcs_from_package("mac", "verilog/mac_delta_consecutive.v")
...
@pytest.mark.parametrize("is_signed", [True])
def test_mac_delta_consecutive_dsp_build(
    cocotb_test_fixture: CocotbTestFixture,
    bitwidth: int,
    deltawidth: int,
    num_params: int,
