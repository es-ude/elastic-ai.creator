...
from elasticai.creator_plugins.interface.tests.spi_slave_woclk_tb import cocotb_settings


class VerilogSpiSlaveWithoutClk(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_6bit_cpol0_cpha0_lsb(self):
        ...
        sets0['params'] = {'BITWIDTH': 6, 'CPOL': 0, 'CPHA': 0, 'MSB': 0}
        run_cocotb_sim_for_src_dir (**sets0)
        self.assertTrue(check_cocotb_test_result())

    def test_6bit_cpol0_cpha1_lsb(self):
        sets0 = deepcopy(cocotb_settings)
        sets0['params'] = {'BITWIDTH': 6, 'CPOL': 0, 'CPHA': 1, 'MSB': 0}
        run_cocotb_sim_for_src_dir (**sets0)
        self.assertTrue(check_cocotb_test_result())

    def test_6bit_cpol1_cpha0_lsb(self):
        sets0 = deepcopy(cocotb_settings)
        sets0['params'] = {'BITWIDTH': 6, 'CPOL': 1, 'CPHA': 0, 'MSB': 0}
        run_cocotb_sim_for_src_dir (**sets0)
        self.assertTrue(check_cocotb_test_result())

    def test_6bit_cpol1_cpha1_lsb(self):
        sets0 = deepcopy(cocotb_settings)
        sets0['params'] = {'BITWIDTH': 6, 'CPOL': 1, 'CPHA': 1, 'MSB': 0}
        run_cocotb_sim_for_src_dir (**sets0)
        self.assertTrue(check_cocotb_test_result())

    def test_6bit_cpol0_cpha0_msb(self):
        sets0 = deepcopy(cocotb_settings)
        sets0['params'] = {'BITWIDTH': 6, 'CPOL': 0, 'CPHA': 0, 'MSB': 1}
        run_cocotb_sim_for_src_dir (**sets0)
        self.assertTrue(check_cocotb_test_result())

    def test_6bit_cpol0_cpha1_msb(self):
        sets0 = deepcopy(cocotb_settings)
        sets0['params'] = {'BITWIDTH': 6, 'CPOL': 0, 'CPHA': 1, 'MSB': 1}
        run_cocotb_sim_for_src_dir (**sets0)
        self.assertTrue(check_cocotb_test_result())

    def test_6bit_cpol1_cpha0_msb(self):
        sets0 = deepcopy(cocotb_settings)
        sets0['params'] = {'BITWIDTH': 6, 'CPOL': 1, 'CPHA': 0, 'MSB': 1}
        run_cocotb_sim_for_src_dir (**sets0)
        self.assertTrue(check_cocotb_test_result())

    def test_6bit_cpol1_cpha1_msb(self):
        sets0 = deepcopy(cocotb_settings)
        sets0['params'] = {'BITWIDTH': 6, 'CPOL': 1, 'CPHA': 1, 'MSB': 1}
        run_cocotb_sim_for_src_dir (**sets0)
        self.assertTrue(check_cocotb_test_result())

    def test_16bit_cpol0_cpha0_lsb(self):
        sets0 = deepcopy(cocotb_settings)
        sets0['params'] = {'BITWIDTH': 16, 'CPOL': 0, 'CPHA': 0, 'MSB': 0}
        run_cocotb_sim_for_src_dir (**sets0)
        self.assertTrue(check_cocotb_test_result())

    def test_16bit_cpol0_cpha1_lsb(self):
        sets0 = deepcopy(cocotb_settings)
        sets0['params'] = {'BITWIDTH': 16, 'CPOL': 0, 'CPHA': 1, 'MSB': 0}
        run_cocotb_sim_for_src_dir (**sets0)
        self.assertTrue(check_cocotb_test_result())

    def test_16bit_cpol1_cpha0_lsb(self):
        sets0 = deepcopy(cocotb_settings)
        sets0['params'] = {'BITWIDTH': 16, 'CPOL': 1, 'CPHA': 0, 'MSB': 0}
        run_cocotb_sim_for_src_dir (**sets0)
        self.assertTrue(check_cocotb_test_result())

    def test_16bit_cpol1_cpha1_lsb(self):
        sets0 = deepcopy(cocotb_settings)
        sets0['params'] = {'BITWIDTH': 16, 'CPOL': 1, 'CPHA': 1, 'MSB': 0}
        run_cocotb_sim_for_src_dir (**sets0)
        self.assertTrue(check_cocotb_test_result())

    def test_16bit_cpol0_cpha0_msb(self):
        sets0 = deepcopy(cocotb_settings)
        sets0['params'] = {'BITWIDTH': 16, 'CPOL': 0, 'CPHA': 0, 'MSB': 1}
        run_cocotb_sim_for_src_dir (**sets0)
        self.assertTrue(check_cocotb_test_result())

    def test_16bit_cpol0_cpha1_msb(self):
        sets0 = deepcopy(cocotb_settings)
        sets0['params'] = {'BITWIDTH': 16, 'CPOL': 0, 'CPHA': 1, 'MSB': 1}
        run_cocotb_sim_for_src_dir (**sets0)
        self.assertTrue(check_cocotb_test_result())

    def test_16bit_cpol1_cpha0_msb(self):
        sets0 = deepcopy(cocotb_settings)
        sets0['params'] = {'BITWIDTH': 16, 'CPOL': 1, 'CPHA': 0, 'MSB': 1}
        run_cocotb_sim_for_src_dir (**sets0)
        self.assertTrue(check_cocotb_test_result())

    def test_16bit_cpol1_cpha1_msb(self):
        sets0 = deepcopy(cocotb_settings)
        sets0['params'] = {'BITWIDTH': 16, 'CPOL': 1, 'CPHA': 1, 'MSB': 1}
        run_cocotb_sim_for_src_dir (**sets0)
        self.assertTrue(check_cocotb_test_result())
