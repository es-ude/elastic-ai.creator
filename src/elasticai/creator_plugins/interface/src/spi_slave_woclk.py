...
@type_handler_iterable
def spi_slave_without_clk(impl: Implementation) -> Iterable[Code]:
    ...
    _template = (
        ...
        .parameter("MSB")
        .add_module_name()
        .set_prototype(res.read_text(package_path, "verilog/spi_slave_woclk.v"))
        .build()
    )
    ...
    _middleware = (
        ...
        .parameter("MSB")
        .add_module_name()
        .set_prototype(res.read_text(package_path, "verilog/spi_middleware.v"))
        .build()
    )
