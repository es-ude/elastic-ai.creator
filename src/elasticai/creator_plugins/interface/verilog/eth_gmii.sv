...
//                  GMII-Interface mit Übertragungsrate: 1.000 Mbit/s
//                  
// Version:         1v0 
// Date:            19.03.2022
// Description:     TX mit CRC lauflähig (NOCH TESTEN bzw. SLICE)
//                  RX fehlt noch
...
//                  Effizienz von 12,9% (x=8) bis 94,9% (x=1500)
//////////////////////////////////////////////////////////////////////////////////
...
module GMII_ETH_PHY #(
    parameter byte_tx  = 12'd16,
    parameter src_ip   = 32'hEF_FF_FF_FA,
    parameter src_mac  = 48'hFF_FF_FF_FF_FF_FF,
    parameter src_port = 16'h0400,
    parameter dst_ip   = 32'hA9_FE_9D_DF,
    parameter dst_mac  = 48'h00_E0_4C_68_21_A0,
    parameter dst_port = 16'h0400,
    parameter int unsigned RST_CYC = 500_000,
    parameter int unsigned PWRUP_CYC = 100_000_000
    )(
    ...
    localparam int unsigned MIN_FRAME_NIBBLES    = 8'd64;
    localparam int unsigned PREAMBLE_SFD_NIBBLES = 8'd8;
    localparam int unsigned MAC_HEADER_NIBBLES   = 8'd14;
    localparam int unsigned IP_HEADER_NIBBLES    = 8'd20;
    localparam int unsigned UDP_HEADER_NIBBLES   = 8'd8;
    localparam int unsigned WORD_SIZE_NIBBLES    = byte_tx;
    localparam int unsigned PAD_SIZE_NIBBLES     = (8'd18 < WORD_SIZE_NIBBLES) ? 8'd0 : 8'd18 - WORD_SIZE_NIBBLES;
    localparam int unsigned FCS_NIBBLES          = 8'd4;
    localparam int unsigned GAP_NIBBLES          = 8'd12;
    ...
    localparam int unsigned IP_TOS = 8'h00;                 // The IP type of service.
    localparam int unsigned IP_ID = 0;                      // The IP fragment identification.
    localparam int unsigned IP_FLAGS = 0;
    localparam int unsigned IP_FRAG_OFFSET = 0;             // The IP fragmentation offset.
    ...
    function logic [31:0] compute_crc(input logic [31:0] crc, input logic [7:0] data);
    ...
    always_ff@(posedge CLK_500MHz) begin
        if (~nRST) begin
            ...
            PREPARE: begin
                ...
                mac_header.dst_mac    <= dst_mac;
                mac_header.src_mac    <= src_mac;
