...
@type_handler_iterable()
def measure_trigger(impl: DataGraph, _: Registry) -> Iterable[Code]:
    package_path = "elasticai.creator_plugins.peripherie"
    path2file = "verilog/meas_trg_duration.v"

    _template = (
        TemplateDirector()
        .parameter("CNTWIDTH_TRG")
        .parameter("CNTWIDTH_OVR")
        .add_module_name()
