...
@type_handler_iterable()
def lutrom_single_port(impl: DataGraph, _: Registry) -> Iterable[Code]:
    package_path = "elasticai.creator_plugins.bram"
    path2file = "verilog/lutrom_single_port.v"

    _template = (
        TemplateDirector()
        .parameter("BITWIDTH")
        .parameter("ROMWIDTH")
        .localparam("LUTROM_DATA")
        .add_module_name()
