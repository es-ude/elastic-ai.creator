...
@type_handler_iterable()
def mac_delta_array(impl: DataGraph, _: Registry) -> Iterable[Code]:
    package_path = "elasticai.creator_plugins.mac_delta"
    path2file = "verilog/mac_delta_array.v"
